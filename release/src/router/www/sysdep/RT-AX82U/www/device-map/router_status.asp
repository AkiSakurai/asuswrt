...
function genCPUElement(){
	var code = '<div class="division-block status-title"><#Status_CPU#></div>';
	code += '<div>';
	for(i=0;i<core_num;i++){
...
function genRAMElement(){
	var code = '<div class="division-block status-title"><#Status_RAM#></div>';
	code += '<div>';
	code += '<div>';
...
function get_ethernet_ports() {
	$.ajax({
		...
		success: function(response) {
			...
			var code = '<div class="division-block status-title"><#Status_Ethernet_Ports#></div>';
			code += '<div>';
