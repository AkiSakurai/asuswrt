...
do_upgrade_post(char *url, FILE *stream, int len, char *boundary)
{
	...
	long filelen;
	int offset;
#if defined(K3) || defined(K3C) || defined(SBRAC1900P) || defined(SBRAC3200P) || defined(R8000P) || defined(R8500) || defined(RAX20) || defined(XWR3100) || defined(R7000P) || defined(EA6700) || defined(F9K1118) || defined(TY6201_RTK) || defined(TY6201_BCM) || defined(DIR868L)
	int checkname=0;
#endif
...
int get_fronthaul_network_capability_val() {
    ...
    for (int i = 0;  capability_list[i].type != 0; i++) {
