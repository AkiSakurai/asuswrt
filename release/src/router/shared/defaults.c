...
// Wireless Mac Filter
	...
	{ "wl1_bsd_if_select_policy", "eth7 eth5", CKN_STR64, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },
	{ "wl2_bsd_if_select_policy", "eth6 eth5", CKN_STR64, CKN_TYPE_DEFAULT, CKN_ACC_LEVEL_DEFAULT, CKN_ENC_DEFAULT, 0 },
#else
...
#endif
#if defined(RTN300) || defined(RTCONFIG_ALL_DEF_LAN50) || defined(RTN300) || defined(R8000P) 
...
#if defined(RTN300) || defined(RTCONFIG_HND_ROUTER_AX) || defined(RTCONFIG_ALL_DEF_LAN50) || defined(RTN300) || defined(R8000P) 
...
#if defined(R8000P) || defined(SBRAC1900P) || defined(SBRAC3200P)
