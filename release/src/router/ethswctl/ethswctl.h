...
"           type = 0-read all;"
                   ...
                   "1-acb_en; 2-eop_delay; 3- que_flush;"
                   #endif
                   "\n" 
                   #if defined(ACB_ALGORITHM2)
"                  4-algorithm; "
...
"                   --ipsa <IPv4 address>,[<mask>]      : Destination IP address.\n"
"                   --ipda <IPv4 address>,[<mask>]      : Source IP address.\n"
...
"                   --chng_fpmap_ib <0-3>       : Change in-band traffic Forwarding Port Map\n"
"                                               : 0-No change to ARL result, 1-Remove DST_MAP from ARL result\n"
"                                                 2-Replace ARL result with DST_MAP; 3: Add DST_MAP to ARL result\n"
"                                                 If omitted and --dst_fpmap_ib set, replacement will be performed\n"
"                   --fpmap_ib <0-0x1ff>        : New in-band Fowarding Port Map used by --change_fwd_map_ib\n"
"                   ----------------------- <Example> -----------------------------------------------------------------\n"
"                      ethswctl -c cfp --da 102233445566 --chng_fpmap_ib 2 --fpmap_ib 0  # Discard matched DA packets.\n"
"                      ethswctl -c cfp --ipda 192.168.0.0,255.255.0.0 --chng_fpmap_ib 2 --fpmap_ib 0x108\n" 
...
"    ethswctl {-c|--command} bondingports -v <port masks; BitN=Port N, N=0~4; 0=Set to default>\n",
};
