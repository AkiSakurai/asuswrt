...
typedef enum {
    WLCSM_MNGR_CMD_RESTART=1, 		/**< applicaiton request wlmngr to restart */
    WLCSM_MNGR_CMD_UPDATE_STALIST, 	/**< applicaiton request wlmngr to update it STA lists- from wlevt*/
    WLCSM_MNGR_CMD_VALIDATE_DM_VAR, 	/**< applicaiton request wlmngr to validate dm var which in oid object*/
    ...
    WLCSM_MNGR_CMD_PWRRESET, 	/**< pwrreset*/
...
//int wlcsm_mngr_update_stalist(unsigned int radio_idx,unsigned int sub_idx);
