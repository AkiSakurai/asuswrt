...
static int LED_status = 1;
static int LED_status_changed = 0;
void led_control_r7900p(void)
{
	if (LED_status_changed){
		LED_status = get_gpio(52);
		if (LED_status != LED_status_old){
			gpio_dis(LED_status_old);
...
#if defined(SBRAC1900P) || defined(SBRAC3200P) || defined(R8000P)
...
#endif
#if defined(K3) || defined(K3C) || defined(R8000P) || defined(F9K1118) || defined(SBRAC1900P) || defined(XWR3100) || defined(R8500) || defined(EA6700)
#if defined(MERLINR_VER_MAJOR_R) || defined(MERLINR_VER_MAJOR_X)
static void check_auth_code()
{
	static int i;
	if (i==0)
		i=auth_code_check(nvram_get("merlinrmac"), nvram_get("uuid"));
	if (i==0){
		static int count;
