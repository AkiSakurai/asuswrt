...
#endif
#if defined(RTAX86U) || defined(RTAX5700) || defined(RTCONFIG_EXT_BCM53134) || defined(GTAXE11000)
...
void set_acs_ifnames()
{
	...
	/* exclude UNII-4 channaels, remove it once powertable is ready */
	strncat(list, ",0xd0a9,0xd0ad,0xd0b1,0xd8a7,0xd9a7,0xd8af,0xd9af,0xe0ab,0xe1ab,0xe2ab,0xe3ab,0xeca3,0xeda3,0xeea3,0xefa3", sizeof(list)-strlen(list)-1);

	nvram_set("wl1_acs_excl_chans", list);

	/* WAR: exclude acsd from selecting chanspec 6g1, 6g5, 6g9, 6g13, 6g17, 6g21, 6g25,6g29 bw20/40/80/160 */
	nvram_set("wl2_acs_excl_chans", "0x5001,0x5002,0x5005,0x5009,0x500d,0x5011,0x5015,0x5019,0x501d,0x5803,0x5903,0x580b,0x590b,0x5813,0x5913,0x581b,0x591b,0x6007,0x6107,0x6207,0x6307,0x6017,0x6117,0x6217,0x6317,0x680f,0x690f,0x6a0f,0x6b0f,0x6c0f,0x6d0f,0x6e0f,0x6f0f");
#else
