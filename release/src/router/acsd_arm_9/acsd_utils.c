 ...
 *
 * $Id: acsd_utils.c 554956 2015-05-07 05:36:55Z $
 */
...
acsd_malloc(int bufsize)
{
	...
	ACSD_DEBUG("address: 0x%p, size %d\n", buf, bufsize);
	return buf;
}
...
acs_dump_score(ch_score_t * score_p)
{
	...
	ACSD_INFO("Channel Score Breakdown:\n");
	ACSD_INFO("Fact\t Score   \t Weight  \t SubTotal\t\n");
