 ...
 *
 * $Id: dbus_usb_linux.c 471726 2014-04-21 22:33:42Z $
 */
...
dbus_usbos_sleep(usbos_info_t *usbos_info)
{
	...
	*/
	SPINWAIT((atomic_read(&usbos_info->txposted) != 0 ||
		atomic_read(&usbos_info->rxposted) != 0), 9000);
	if (atomic_read(&usbos_info->txposted) != 0 || atomic_read(&usbos_info->rxposted) != 0) {
