 ...
 *
 * $Id: wlc_offloads.c 472405 2014-04-23 23:46:55Z $
 */
...
static void wlc_ol_bsscfg_updn(void *ctx, bsscfg_up_down_event_data_t *evt)
{
	...
	if ((evt->bsscfg->up) && (evt->up == FALSE) && (!BSSCFG_AWDL(evt->bsscfg))) {
	...
	scb_t *scb, ol_sec_info *info)
{
	...
	info->flags |= WIN7_AND_UP_OS(wlc->pub) ? OL_SEC_F_WIN7PLUS : 0;
