 ...
 *
 * $Id: wlc_vht.h 467328 2014-04-03 01:23:40Z $
 */
...
extern INLINE bool wlc_vht_prep_rate_info(wlc_vht_info_t *vhti, wlc_d11rxhdr_t *wrxh,
...
extern void wlc_vht_bsscfg_complete_downgrade(wlc_vht_info_t *vhti);
