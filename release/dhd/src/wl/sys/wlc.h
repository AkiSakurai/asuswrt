 ...
 *
 * $Id: wlc.h 473075 2014-04-27 07:10:27Z $
 */
...
#define WLC_MAXMODULES		67	/* max #  wlc_module_register() calls */
#endif
...
#ifdef USING_MUX
	wlc_info_t*		wlc;
	wlc_mux_t*		ac_mux[AC_COUNT];
	mux_source_handle_t	mux_hdl[AC_COUNT];
#endif /* USING_MUX */
#endif /* NEW_TXQ */
};
...
#define WLC_USER_WAKE_REQ_VHT		0x00000002
...
extern INLINE bool rfc894chk(wlc_info_t *wlc,
