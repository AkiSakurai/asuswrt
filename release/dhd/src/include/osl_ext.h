 ...
 * $Id: osl_ext.h 472903 2014-04-25 18:40:10Z $
 */
...
/****************************************************************************
* Function:   osl_ext_interrupt_enable
*
* Purpose:    Enable CPU interrupt.
*
* Parameters: None.
*
* Returns:    None.
*****************************************************************************
*/
void osl_ext_interrupt_enable(void);
...
/****************************************************************************
* Function:   osl_ext_interrupt_is_enabled
*
* Purpose:    Check if CPU interrupt are enabled.
*
* Parameters: None.
*
* Returns:    TRUE if interrupt is enabled, else FALSE.
*****************************************************************************
*/
bool osl_ext_interrupt_is_enabled(void);
