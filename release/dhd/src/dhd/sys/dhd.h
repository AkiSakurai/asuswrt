 ...
 *
 * $Id: dhd.h 498097 2014-08-21 22:49:49Z $
 */
...
/* #define WL_ENABLE_P2P_IF		1 */
	...
	*/
	...
	bool grat_arp;
#endif /* DHD_L2_FILTER */
#define MAX_ARP_PKTLEN	48
	uint8 arpbuf[MAX_ARP_PKTLEN];
} dhd_pub_t;
#if defined(CUSTOMER_HW4)
...
typedef struct dhd_pkttag_fd {
	...
	dmaaddr_t physaddr; /* physical address */
} dhd_pkttag_fd_t;
...
#define DHD_PKT_GET_PHYSADDR(pkt)   ((DHD_PKTTAG_FD(pkt))->physaddr)
#define DHD_PKT_SET_PHYSADDR(pkt, pkt_physaddr) \
	({ DHD_PKTTAG_FD(pkt)->physaddr = (dmaaddr_t)(pkt_physaddr); })

#if defined(PROP_TXSTATUS)
/* Pkttag not compatible with PROP_TXSTATUS or WLFC */
#error "Pkttag not compatible with PROP_TXSTATUS or WLFC"
#endif /* PROP_TXSTATUS */
