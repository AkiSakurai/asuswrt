 ...
 *
 * $Id: dhdu.c 499316 2014-08-28 09:22:14Z $
 */
...
cmd_t dhd_cmds[] = {
	...
	"set/get dev_def" },
	{ "psta", dhd_varint, DHD_GET_VAR, DHD_SET_VAR,
	"g/set psta mode"},
	{ NULL, NULL, 0, 0, NULL }
};
...
dhd_bsscfg_int(void *dhd, cmd_t *cmd, char **argv)
{
	...
	if ((ret = get_ifname_unit(((struct ifreq *)dhd)->ifr_name, NULL, &vif)) != 0) {
		printf("%s: get_ifname_unit failed. ret = %d \n", __FUNCTION__, ret);
		return -1;
	}
