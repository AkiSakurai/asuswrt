 ...
 *
 * $Id: bcmevent.h 472391 2014-04-23 23:32:04Z $
 *
 */
...
#define WLC_E_PSTA_CREATE_IND	141	/* PSTA alias creation indication */
#define WLC_E_LAST			142	/* highest val + 1 for range checking */
#if (WLC_E_LAST > 142)
...
/* WLC_E_PSTA_CREATE_IND event */
typedef struct wl_psta_create_event {
	struct ether_addr ds_ea;	/* Original MAC address of client */
	struct ether_addr psta_ea;	/* Proxy MAC address of client */
} wl_psta_create_event_t;
