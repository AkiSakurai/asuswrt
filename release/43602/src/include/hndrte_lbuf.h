 ...
 *
 * $Id: hndrte_lbuf.h 484898 2014-06-13 11:24:37Z $
 */
...
#define MAXPKTRXFRAGSZ  224	/* enough for d11 headers + lbuf_frag overhead */
...
struct lbuf_finfo {
	union {
		...
		struct {			/* element 0 in array of lbuf_finfo */
			...
			uint16 fnum;	/* total number of fragments in this lbuf */
