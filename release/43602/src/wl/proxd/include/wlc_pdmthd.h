 ...
 *
 * $Id: wlc_pdmthd.h 451999 2014-01-28 21:57:46Z $
 */
...
struct tof_rtd_adj_params {
	...
	int		thresh_scale;	/* scale number of simple threshold crossing */
	int		thresh_log2;	/* log2 number of simple threshold crossing */
	int		w_len;		/* search window length */
	int		w_offset;	/* search window offset */
	int32		*w_ext;		/* hardware channel smoothing data */
	int32		gd_ns;		/* groud delay */
