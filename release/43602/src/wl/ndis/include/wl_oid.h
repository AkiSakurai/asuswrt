 ...
 *
 * $Id: wl_oid.h 471659 2014-04-21 17:43:21Z $
 */
#ifndef _wl_oid_h_
#define _wl_oid_h_
...
#if !defined(EXT_STA) || (NDISVER < 0x0620)
...
extern bool wl_aps_active(struct wl_info *wl);
extern bool wl_stas_active(struct wl_info *wl);
#endif /* EXT_STA */
...
extern void wl_add_assoc_ie(wl_oid_t *oid, struct ether_addr *bssid);
#endif /* (NDISVER >= 0x0620) */
...
extern void wl_oid_event(wl_oid_t *oid, wlc_event_t *e);
...
#define WL_ASSOCIATED(wl) ((wl)->vars.associated)
