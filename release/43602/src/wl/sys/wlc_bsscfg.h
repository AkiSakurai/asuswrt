 ...
 *
 * $Id: wlc_bsscfg.h 485790 2014-06-17 12:19:56Z $
 */
...
#ifdef WL_NAN
#define BSSCFG_NAN(cfg)	((cfg) && ((cfg)->flags2 & WLC_BSSCFG_FL2_NAN))
#else
...
struct wlc_bsscfg {
	...
	bool osen;
	bool	roamoffl;	/* roaming offload */
};

#ifdef NO_ROAMOFFL_SUPPORT
#define BSSCFG_ROAMOFFL(_roamoffl)	(0)
#else
#define BSSCFG_ROAMOFFL(_roamoffl)	(_roamoffl)
#endif
...
#define WLC_BSSCFG_FL2_AIBSS		0x4	/* The BSS is for AIBSS */
...
#ifdef WLAIBSS
#define BSSCFG_IS_AIBSS(cfg)	(((cfg)->flags2 & WLC_BSSCFG_FL2_AIBSS) != 0)
#else
#define BSSCFG_IS_AIBSS(cfg)	FALSE
#endif
