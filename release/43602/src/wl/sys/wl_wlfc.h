...
* $Id: wl_wlfc.h 443023 2013-12-13 19:18:26Z $
*
*/
...
#define WLFC_COUNTER_TXSTATUS_TOD11(wlc)	do \
	{(wlfc_state_get((wlc)->wl))->stats.wlfc_to_D11++;} while (0)
#define WLFC_COUNTER_TXSTATUS_WLCTOSS(wlc)	do \
	{(wlfc_state_get((wlc)->wl))->stats.wlfc_wlfc_toss++;} while (0)
#else
