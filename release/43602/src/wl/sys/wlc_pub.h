 ...
 *
 * $Id: wlc_pub.h 492293 2014-07-21 09:18:58Z $
 */
...
#ifdef WL_SHIF
	bool		_shif;			/* enable/disable sensor hub interface */
#endif /* WL_SHIF */
 ...
 */
#define WLF_RXPKTFETCH_CHECK_DONE	0x00010000	/* pkt checked for pktfetch requirements */
...
#ifdef WL_SHIF
	#if defined(WL_ENAB_RUNTIME_CHECK)
		#define SHIF_ENAB(pub)   ((pub)->_shif)
