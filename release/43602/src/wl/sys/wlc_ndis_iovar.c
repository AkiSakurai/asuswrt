...
const bcm_iovar_t ndis_iovars[] = {
	...
	(0), IOVT_BUFFER, sizeof(assoc_decision_t)
	},
	{"if_add", IOV_IF_ADD,
	...
	void *params, uint p_len, void *arg, int len, int val_size, struct wlc_if *wlcif)
{
	...
	case IOV_GVAL(IOV_DEFAULT_RATESET): {
		wl_rates_info_t *rates_info = (wl_rates_info_t *)arg;
		...
		rates_info->rs_tgt.count = rs_tgt.count;
		bcopy(&rs_tgt.rates, &rates_info->rs_tgt.rates, WLC_NUMRATES * sizeof(uint8));
		break;
	}
