 ...
 *
 * $Id: wlc_phy_int.h 519478 2014-12-07 04:14:38Z $
 */
...
#if defined(PHYCAL_CACHING) || (defined(WLMCHAN) && !defined(WLMCHAN_DISABLED))
...
extern void wlc_phy_desense_aci_reset_params_acphy(phy_info_t *pi, bool call_gainctrl, bool all2g,
                                                   bool all5g);
