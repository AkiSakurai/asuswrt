 ...
 *
 * $Id: siutils.c 485790 2014-06-17 12:19:56Z $
 */
                       ...
                       uint bustype, void *sdh, char **vars, uint *varsz)
{
	...
	*/
	...
	/* if chip id is 43569 and rev is 1, change chipid to 4358 in software */
	if ((CHIPID(sih->chip) == BCM43569_CHIP_ID) && (CHIPREV(sih->chiprev) == 1))
	{
