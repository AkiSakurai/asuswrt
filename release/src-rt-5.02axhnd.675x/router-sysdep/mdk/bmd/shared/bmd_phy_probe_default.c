...
//          expand PHY_PROBE() and remove unnecessary comparison to avoid -Werror=address error in newer compiler
            if (CDK_SUCCESS(pc_probe.drv->pd_probe == NULL ? CDK_E_UNAVAIL : pc_probe.drv->pd_probe(&pc_probe))) {
