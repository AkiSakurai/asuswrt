...
static int RstBtnPressed(void)
{
    ...
    unsigned short gpioPin = 23;
#else
#error "Need to set the RstBtn gpio at RstBtnPressed()!!!"
#endif
...
#elif defined(RTAX68U)
    unsigned short gpioPin = 22;
#else
#error "Need to set the WPSBtn gpio at checkForSesBtnWirelessHold()!!!"
#endif
...
void board_final_init(int force_cfe)
{
    ...
    if (RstBtnPressed()) {
        ...
        if (BpGetBootloaderPowerOnLedGpio(&gpio) != BP_SUCCESS)
            ...
            gpio = 4 | BP_ACTIVE_LOW;
#else
#error "Need to set the PwrLed gpio at board_final_init()!!!"
#endif
