...
extern void wlc_cfp_amsdu_tx_counter_upd(wlc_info_t *wlc, uint32 nmsdu, uint32 totlen);
...
extern uint32 wlc_amsdu_scb_max_sframes(amsdu_info_t *ami, struct scb *scb, uint8 tid);
...
#ifdef	WLCFP
extern void wlc_amsdu_agg_attempt(amsdu_info_t *ami, struct scb *scb, void *p, uint8 tid);
