 ...
 *
 * $Id: wlc_csa.h 773871 2019-04-02 09:30:10Z $
*/
...
#ifdef AWDL_DFSP
extern void wlc_monitor_csa_activity(wlc_csa_info_t *csam, wlc_bsscfg_t *cfg, uint8 *body,
	int bodylen);
#endif /* AWDL_DFSP */
...
#define wlc_monitor_csa_activity(csam, cfg, body, bodylen) do {} while (0)
