 ...
 *
 * $Id: wlc_ie_mgmt_vs.c 774133 2019-04-11 09:15:54Z $
 */
...
static bool wlc_ignore_assoc_oui(wlc_assoc_oui_t  *assoc_oui,  uint8 *ie);
...
static const struct {
	...
	{{MSFT_OUI, WME_OUI_TYPE}, WLC_IEM_VS_IE_MSFT_WME_PRIO},
#endif /* WL_FILTERIE */
#ifdef MULTIAP
...
#if defined(WL_FILTERIE)
	{BRCM_PROP_OUI, WLC_IEM_VS_IE_BRCM_OUI_PRIO},
	{MSFT_OUI, WLC_IEM_VS_IE_MSFT_OUI_PRIO},
	{WFA_OUI, WLC_IEM_VS_IE_WFA_OUI_PRIO},
#endif /* WL_FILTERIE */
};
