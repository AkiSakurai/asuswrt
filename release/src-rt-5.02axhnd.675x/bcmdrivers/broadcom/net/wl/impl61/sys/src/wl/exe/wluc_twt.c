 ...
 *
 * $Id: wluc_twt.c 774769 2019-05-07 08:46:22Z $
 */
...
#ifdef NEED_STRTOULL
/* XXX Used strtoul() code in bcmstdlib.c as the reference.
 * Not sure how bcmstdlib.c is used in EFI and WINXP/WIN7
 * builds when building wl utility. It can be moved to
 * bcmstdlib.c if bcmstdlib.c is built into wl utility
 * in these builds but in case bcmstdlib.c is not it has
 * to say here.
 */
