 ...
 *
 * $Id: wlc_wnm.c 773397 2019-03-19 18:02:49Z $
 */
...
#if defined(WL_MBO) && !defined(WL_MBO_DIABLED)
...
#endif /* WL_MBO && !WL_MBO_DISABLED */
		wlc_wnm_send_bsstrans_request(wnm, bsscfg, scb, transquery->token, reqmode, 0, 0,
			add_self_bss_info);
		break;
	}
