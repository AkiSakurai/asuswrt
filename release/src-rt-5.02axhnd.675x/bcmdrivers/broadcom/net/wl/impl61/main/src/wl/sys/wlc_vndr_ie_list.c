 ...
 *
 * $Id: wlc_vndr_ie_list.c 689268 2017-03-09 15:55:46Z $
 */
...
#if defined(WL_FILTERIE)
			if (!wlc_filter_ie_is_ie_allowed(arg, pktflag, TRUE, WLC_IEM_VS_ID_MAX,
				FALSE, (const vndr_ie_t *)&curr->vndr_ie_infoel.vndr_ie_data)) {
				continue;
			}
#endif /* WL_FILTERIE */
