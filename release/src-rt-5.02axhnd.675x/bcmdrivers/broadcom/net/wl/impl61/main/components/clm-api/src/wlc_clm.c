...
static const flag_translation_t country_flag_2_translations [] = {
	...
	{CLM_DATA_FLAG_2_REG_DDSA, CLM_FLAG_DDSA}
};
	...
	int loc_type)
{
	 ...
	 * However this detected as OOB when loc_type exceeds size of
	 * clm_country_rev_definition_cd10_t::locales[], which happens when
	 * 6GHz data is used (and is not an OOB)
	 */
