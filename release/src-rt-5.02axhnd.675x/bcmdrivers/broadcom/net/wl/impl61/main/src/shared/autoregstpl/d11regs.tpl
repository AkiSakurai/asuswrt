...
FEATURE_BEGIN[regs_common_ge128_lt129]
	...
	uint16 SUSPREQ1 #,0x00D4,SUSPREQ1
	uint16 FLUSHREQ1 #,0x00D8,FLUSHREQ1
	uint16 CHNFLUSH_STATUS1 #,0x00DC,CHNFLUSH_STATUS1
	uint16 CHNSUSP_STATUS1 #,0x00E0,CHNSUSP_STATUS1
	uint16 SUSPREQ2 #,0x00E4,SUSPREQ2
	uint16 FLUSHREQ2 #,0x00E8,FLUSHREQ2
	uint16 CHNFLUSH_STATUS2 #,0x00EC,CHNFLUSH_STATUS2
	uint16 CHNSUSP_STATUS2 #,0x00F0,CHNSUSP_STATUS2
	...
	uint16 gptimer_R1 #,0x0320,gptimer_R1
	uint16 MACCONTROL_r1 #,0x0324,MACCONTROL_r1
	uint16 MacControl1_R1 #,0x0328,MacControl1_R1
	uint16 MACCOMMAND_R1 #,0x032C,MACCOMMAND_R1
	uint16 MACINTSTATUS_R1 #,0x0330,MACINTSTATUS_R1
	uint16 MACINTMASK_R1 #,0x0334,MACINTMASK_R1
	uint16 ALT_MACINTSTATUS_R1 #,0x0338,ALT_MACINTSTATUS_R1
	uint16 ALT_MACINTMASK_R1 #,0x033C,ALT_MACINTMASK_R1
	uint16 PSM_DEBUG_R1 #,0x0360,PSM_DEBUG_R1
	uint16 TSFTimerLow_R1 #,0x0364,TSFTimerLow_R1
	uint16 TSFTimerHigh_R1 #,0x0368,TSFTimerHigh_R1
	...
	uint16 PSM_RLMEM_IDX #,0x0872,PSM_RLMEM_IDX
