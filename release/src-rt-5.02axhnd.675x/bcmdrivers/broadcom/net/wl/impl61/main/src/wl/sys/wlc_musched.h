...
/* musched ul policy definition */
#define MUSCHED_UL_POLICY_DISABLE		0
#define MUSCHED_UL_POLICY_BASIC			1
#define MUSCHED_UL_POLICY_MAX			1
#define MUSCHED_UL_POLICY_AUTO			(-1)

/* HE sounding type */
#define MUSCHED_HESNDTP_AUTO		(-1)
#define MUSCHED_HESNDTP_HETB		0 /* HETB sounding */
#define MUSCHED_HESNDTP_SEQHESU		1 /* sequential HE SU */
#define MUSCHED_HESNDTP_BFP		2 /* BF poll based */
#define MUSCHED_HESNDTP_MAX		MUSCHED_HESNDTP_BFP

#define MUSCHED_ULOFDMA_MAX_NUM_USERS		8
...
/* UL OFDMA */
extern void wlc_musched_admit_ulclients(wlc_info_t *wlc, scb_t *scb, bool admit);

extern uint8 wlc_musched_get_he_sounding_type(wlc_muscheduler_info_t *musched);
extern void wlc_musched_upd_ul_nss(wlc_muscheduler_info_t *musched, scb_t* scb, uint8 tx_nss);
#if defined(WL11AX) && defined(WL_PSMX)
extern void wlc_musched_chanspec_upd(wlc_info_t *wlc);
#else
#define wlc_musched_chanspec_upd(a) do {} while (0)
...
extern int wlc_musched_upd_ul_stats(wlc_muscheduler_info_t *musched, struct scb *scb,
	tx_status_t *txs);
extern int wlc_musched_upd_ul_rustats(wlc_muscheduler_info_t *musched, struct scb *scb,
	tx_status_t *txs);
#endif // endif
#ifdef WL_MUSCHEDULER
extern void wlc_musched_max_clients_set(wlc_muscheduler_info_t *musched);
#else
#define wlc_musched_max_clients_set(a) do {} while (0)
