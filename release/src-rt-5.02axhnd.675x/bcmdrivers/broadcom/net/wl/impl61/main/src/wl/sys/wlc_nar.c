 ...
 *
 * $Id: wlc_nar.c 776836 2019-07-11 06:45:24Z $
 *
 */
	...
	taf_scheduler_public_t* taf)
{
	...
	if (taf->how != TAF_RELEASE_LIKE_IAS && taf->how != TAF_RELEASE_LIKE_DEFAULT) {
#ifdef BCMDBG
...
wlc_nar_get_taf_scb_pktq(void *scbh)
{
	nar_scb_cubby_t * cubby = (nar_scb_cubby_t *)scbh;
