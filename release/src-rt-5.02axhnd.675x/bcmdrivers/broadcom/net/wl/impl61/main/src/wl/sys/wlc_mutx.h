...
void wlc_mutx_sta_fifo_bitmap(wlc_mutx_info_t *mu_info, struct scb *scb, void *fifo_bitmap);
bool wlc_mutx_txfifo_ac_matching(uint fifo, uint ac);
...
bool wlc_mutx_is_hemmu_enab(wlc_mutx_info_t *mu_info, uint8 bw);
void wlc_mutx_hemmu_omibw_upd(wlc_mutx_info_t *mu_info, scb_t *omi_scb, int8 from_bw, int8 to_bw);
void wlc_mutx_he_eval_and_admit_clients(wlc_mutx_info_t *mutx, scb_t *scb, bool assocd);
#endif   /* _wlc_mutx_h_ */
