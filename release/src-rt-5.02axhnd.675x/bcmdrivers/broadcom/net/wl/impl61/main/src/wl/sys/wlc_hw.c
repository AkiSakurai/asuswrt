 ...
 *
 * $Id: wlc_hw.c 775407 2019-05-29 15:42:15Z $
 */
...
wlc_hw_update_nfifo(wlc_hw_info_t *wlc_hw)
{
	...
	wlc_hw->pub->nfifo_total = (D11REV_IS(wlc_hw->corerev, 131) ? NFIFO_EXT_REV131 :
...
wlc_ap_mute(wlc_info_t *wlc, bool mute, wlc_bsscfg_t *cfg, uint32 user)
{
	...
	ap = (AP_ACTIVE(wlc) ||
#ifdef STA
		wlc_non_slotted_ibss_active(wlc) ||
#endif /* STA */
