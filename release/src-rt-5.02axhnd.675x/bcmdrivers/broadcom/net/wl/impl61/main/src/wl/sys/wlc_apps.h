 ...
 *
 * $Id: wlc_apps.h 775257 2019-05-24 11:26:25Z $
*/
...
extern void wlc_apps_bcmc_force_ps_by_twt(wlc_info_t *wlc, wlc_bsscfg_t *bsscfg, bool on);
...
extern bool wlc_apps_twt_enter_ps(wlc_info_t *wlc, scb_t *scb);
extern void wlc_apps_twt_release(wlc_info_t *wlc, scb_t *scb);
...
#define wlc_apps_bcmc_force_ps_by_twt(a, b, c) do {} while (0)
