 ...
 *
 * $Id: wlc_mcnx.h 695448 2017-04-20 09:49:55Z $
 */
...
#ifdef WLRSDB
extern int wlc_mcnx_alt_ra_set(wlc_mcnx_info_t *mcnx, wlc_bsscfg_t *cfg);
extern int wlc_mcnx_alt_ra_unset(wlc_mcnx_info_t *mcnx, wlc_bsscfg_t *cfg);
#endif /* WLRSDB */
