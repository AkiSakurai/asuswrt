...
extern void pciedev_hwa_cfp_tx_enabled(struct dngl_bus *pciedev, hwa_txpost_pkt_t * head,
...
void pciedev_hwa_txpost_pkt2native(struct dngl_bus *pciedev, hwa_txpost_pkt_t *head,
...
#define PCIEDEV_TXCPL_RESOURCE_AVAIL_CHECK(pciedev) \
	(hwa_txcple_resource_avail_check(hwa_dev))
#define PCIEDEV_TXCPL_RESOURCE_AVAILABLE(pciedev) \
	(PCIEDEV_TXCPL_RESOURCE_AVAIL_CHECK(pciedev))
