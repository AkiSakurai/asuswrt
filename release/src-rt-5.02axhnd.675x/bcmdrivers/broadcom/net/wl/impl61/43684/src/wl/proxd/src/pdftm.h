 ...
 *
 * $Id: pdftm.h 689565 2017-03-11 02:18:24Z $
 */
...
enum {
	...
	FTM_VS_MEAS_F_TSPT1NS		= FTM_VS_F_TSPT1NS	/* 0.1ns timestamps */
};
...
int pdftm_vs_rx_frame(pdftm_t *ftm, wlc_bsscfg_t *bsscfg,
	const dot11_management_header_t *hdr, const uint8 *body, int body_len,
	const wlc_d11rxhdr_t *wrxh, ratespec_t rspec);
