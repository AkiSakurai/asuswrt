 ...
 *
 * $Id: wlc_wapi.h 613060 2016-01-16 01:32:36Z $
 */
 ...
 */
#define WAPI_WAI_ETHER_HDR	"\x88\xB4"
#define WAPI_WAI_ETHER(pbody)	(bcmp(WAPI_WAI_ETHER_HDR, (pbody), ETHER_TYPE_LEN) == 0)

#define WAPI_WAI_SNAP_HDR	"\xAA\xAA\x03\x00\x00\x00\x88\xB4"
#define WAPI_WAI_SNAP(pbody)	(bcmp(WAPI_WAI_SNAP_HDR, (pbody), DOT11_LLC_SNAP_HDR_LEN) == 0)

#define WAPI_WAI_HDR(pbody, hdr_conv) \
	(hdr_conv ? WAPI_WAI_ETHER(pbody) : WAPI_WAI_SNAP(pbody))
...
extern void wlc_wai_event_indicate(wlc_info_t *wlc, void *p, struct scb *scb,
