...
BASE_FW_IMAGE		:= pcie-ag-splitrx-mfp-pktctx-amsdutx-ampduretry-ringer-dmaindex16-txbf-hostpmac-dhdhdr-avs-cu-vasip-ampduhostreorder-murx-wrr-sae

# FDAP features
FDAP_FEATURES		:= fdap-mbss-wl11k-wl11u-wnm-chanim-bgdfs-cevent-pspretend-stamon-fbt-osen-obss-dbwsw-mbo-swprbrsp-mutx-cca-ccamesh-map-splitassoc-led-slvradar-atm-memallocstats
...
TARGET_OPTIONS_config_sdio_ate				:= sdio-ag-ate-dump-fdap
