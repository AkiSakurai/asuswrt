 ...
 *
 * $Id: wlc_pdmthd.h 681798 2017-01-28 11:09:32Z $
 */
...
extern int wlc_pdtof_ol_measure_results(uint64 *tx, uint64 *rx,
	int32 *gd, int32 *adj, int8 *rssip, bool *discard, uint16 id, bool initiator,
	bool acked, uint16 shmemptr, wlc_info_t *wlc,
...
#endif // endif
extern int wlc_tof_dbg_seq_iov(pdmthd_if_t* svcif, uint32 flags, int* p_result);
#endif /* WL_TOF */
