...
static void rte_shif_uart_dpc(void *cbdata, uint intstatus);
...
static void
rte_shif_uart_proc(void *cbdata, uint intstatus)
{
	shif_info_t *cd = (shif_info_t *)cbdata;
	int iir_st, lsr, c;
...
static void
rte_shif_uart_dpc(void *cbdata, uint intstatus)
{
	rte_shif_uart_proc(cbdata, intstatus);
}
