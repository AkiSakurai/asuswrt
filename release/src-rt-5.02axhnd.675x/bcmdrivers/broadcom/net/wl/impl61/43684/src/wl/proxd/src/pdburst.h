 ...
 *
 * $Id: pdburst.h 689323 2017-03-10 00:15:10Z $
 */
...
typedef int (*pdburst_prep_tx_t)(pdburst_method_ctx_t ctx, pdburst_frame_type_t type, void *pkt,
	uint8 *body, int body_max, int *body_len, const pdburst_tsinfo_t *tsinfo);
...
typedef int (*pdburst_vs_prep_tx_t)(pdburst_method_ctx_t ctx,
	pdburst_frame_type_t type, uint8 *body, int body_max, int *body_len,
