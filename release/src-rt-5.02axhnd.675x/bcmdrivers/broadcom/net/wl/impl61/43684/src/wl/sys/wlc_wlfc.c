 ...
 *
 * $Id: wlc_wlfc.c 774729 2019-05-06 07:45:52Z $
 */
...
wlc_flow_ring_get_scb_handle(wlc_info_t *wlc, struct wlc_if *wlcif, uint8 *da)
{
	...
	if (BSSCFG_SLOTTED_BSS(cfg)) {
		/* By Default NAN and AWDL flowrings has to be in closed state.
...
/* ***** from wlc_awdl.c ***** */
/*
static int wlc_wlfc_awdl_peer_status(void *info, struct scb *scb, uint8 open_close);
*/
#endif // endif
int
