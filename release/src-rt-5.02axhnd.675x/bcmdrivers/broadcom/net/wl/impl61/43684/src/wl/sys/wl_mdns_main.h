 ...
 */
/*
 * $Id: wl_mdns_main.h 611878 2016-01-12 11:11:40Z $
 *
...
extern void mdns_sd_main_init(wlc_mdns_info_t *mdnsi);
extern s32 mDNS_Execute(wlc_mdns_info_t *mdnsi);
extern void mDNSCoreReceive(wlc_mdns_info_t *mdnsi,
