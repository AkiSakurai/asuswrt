 ...
 *
 * $Id: bcmutils.h 715448 2017-08-11 05:34:03Z $
 */
...
#error "BCM_DHDHDR needs PKTC_DONGLE and DUALPKTAMSDU defined."
#endif // endif
...
typedef struct pktpool {
	...
	uint8 cbcnt;
	uint8 ecbcnt;
	uint8 emptycb_disable;	/* disable callback when new packets are added to pool
				 * (2 = pkt was added to pool when callback was disabled)
				 */
	pktpool_cbinfo_t *availcb_excl;
	pktpool_cbinfo_t cbs_reserve[PKTPOOL_CB_MAX];
...
#if defined(BCMDBG) || defined(DHD_DEBUG) || defined(BCMDBG_ERR) || \
	defined(WLMSG_PRHDRS) || defined(WLMSG_PRPKT) || defined(WLMSG_ASSOC) || \
	defined(BCMDBG_DUMP) || defined(WLMEDIA_PEAKRATE) || defined(DBG_PHYTXERR)
