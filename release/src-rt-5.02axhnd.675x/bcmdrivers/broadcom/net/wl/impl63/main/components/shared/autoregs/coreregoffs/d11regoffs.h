...
#if (AUTOREGS_COREREV >= 128) && (AUTOREGS_COREREV < 132)
...
#define PSM_RATEMEM_DBG		(0x00000872)
...
#endif /* (AUTOREGS_COREREV >= 128) && (AUTOREGS_COREREV < 132) */
...
#define TDC_CC12LEN		(0x00000E4A)	/* rename */
#define TDC_NDLIM		(0x00000E98)
#define TDC_MAXNDLIMLEN		(0x00000E9A)
#define TDC_CC34LEN		(0x00000E9C)
#define TDC_BNSYMINIT		(0x00000EA0)
#define TDC_SELK_RATIO		(0x00000EA2)
#define TDC_SELK_OVERHAED	(0x00000EA4)
#define TDC_SELK_TSYM		(0x00000EA6)
#define TDC_SELK_MAXDUR0	(0x00000EA8)
...
#define TXE_PPR_CTL3		(0x000011A8)
