 ...
 *
 * $Id: wlc_ie_mgmt_types.h 779978 2019-10-11 11:31:10Z $
 */
 ...
 *
 * For meta data (wrxh, plcp, hdr, body, rxchan, etc), users (caller and
...
struct wlc_iem_pparm {
	...
	/* TODO:6GHZ: change below field 'rxchan' into 'rxchanspec' so it can hold a 6G channel */
