 ...
 *
 * $Id: rte_isr.h 779823 2019-10-08 11:09:11Z $
 */
...
#define HND_INTSTATS_START(name)							\
	...
	{ ___##name = hnd_isr_stats_create_user(#name, hnd_isr_stats_for_dpc()); }	\
...
hnd_dpc_t* hnd_dpc_get_current(void);
...
hnd_stats_t* hnd_isr_stats_for_dpc(void);
