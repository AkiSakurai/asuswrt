 ...
 */
/*
 * $Id: wl_mdns_common.h 677778 2017-01-05 02:41:12Z $
 *
...
mDNSAddr *get_AllDNSLinkGroup_v4(void);
mDNSAddr *get_AllDNSLinkGroup_v6(void);

#define AllDNSLinkGroupv4 (get_AllDNSLinkGroup_v4()->ip.v4)
#define AllDNSLinkGroupv6 (get_AllDNSLinkGroup_v6()->ip.v6)
...
extern void AssignDomainName(domainname *dst, domainname *src);
