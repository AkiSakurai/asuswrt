 ...
 *
 * $Id: wlc_lq.c 779108 2019-09-19 09:04:11Z $
 */
	...
	wlc_chanim_stats_us_t *cur_stats_us, bool chan_switch)
{
	...
	{
		memcpy(ifaces->if_info[0].acc_us, ifaces->if_info[1].acc_us,
...
#ifdef WLCHANIM_US
					memcpy(ifaces->if_info[1].acc_us, if_info->acc_us,
						sizeof(chanim_acc_us_t));
					ifaces->if_info[1].stats_us = if_info->stats_us;
					ifaces->if_info[1].chanspec = if_info->chanspec;
#endif /* WLCHANIM_US */
#ifdef BCMDBG
