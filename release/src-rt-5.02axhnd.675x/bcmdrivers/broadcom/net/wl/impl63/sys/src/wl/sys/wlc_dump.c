 ...
 *
 * $Id: wlc_dump.c 780751 2019-11-01 21:11:15Z $
 */
...
#define WLC_DUMP_NUM_REGS 12 /* TODO: merge all these defines to a common release dump define ? */
#else
#define WLC_DUMP_NUM_REGS 5
#endif // endif
