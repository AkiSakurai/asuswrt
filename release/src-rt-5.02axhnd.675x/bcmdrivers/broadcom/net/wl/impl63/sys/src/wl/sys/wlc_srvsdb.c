 ...
 *
 * $Id: wlc_srvsdb.c 779517 2019-10-01 14:48:46Z $
 */
...
static const bcm_iovar_t srvsdb_iovars[] = {
	{"force_vsdb", IOV_FORCE_VSDB, IOVF_RSDB_SET, 0, IOVT_UINT8, 0},
	{"force_vsdb_chans", IOV_FORCE_VSDB_CHANS,
	IOVF_SET_UP | IOVF_GET_UP | IOVF_RSDB_SET, 0, IOVT_BUFFER,  2 * sizeof(uint16)},
	{NULL, 0, 0, 0, 0, 0}
};
