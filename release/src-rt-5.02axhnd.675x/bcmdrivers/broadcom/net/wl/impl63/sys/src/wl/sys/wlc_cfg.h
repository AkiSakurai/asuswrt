...
#define MULTIBAND
#define NBANDS(wlc) (wlc_get_nbands(wlc))
#define NBANDS_PUB(pub) (wlc_get_nbands((pub)->wlc))
#define NBANDS_HW(hw) (wlc_get_nbands((hw)->wlc))
#else
#define NBANDS(wlc) 1
