 ...
 *
 * $Id: wlc_scan.h 778844 2019-09-11 13:08:43Z $
 */
...
extern void wlc_scan_get_default_channels(wlc_scan_info_t *wlc_scan_info,
	chanspec_t chanspec_start, int band, chanspec_t *chanspec_list, int *n_channels);
