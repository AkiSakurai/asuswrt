 ...
 *
 * $Id: wlc_amsdu.h 666431 2016-10-21 06:58:37Z $
*/
...
extern void *wlc_recvamsdu(amsdu_info_t *ami, wlc_d11rxhdr_t *wrxh, void *p,
	uint16 *padp, bool chained_sendup);
...
extern void *wlc_amsdu_pktc_agg(amsdu_info_t *ami, wlc_bsscfg_t *bsscfg,
	struct scb *scb, void *p, void *n, uint8 tid, uint32 lifetime);
#endif // endif
