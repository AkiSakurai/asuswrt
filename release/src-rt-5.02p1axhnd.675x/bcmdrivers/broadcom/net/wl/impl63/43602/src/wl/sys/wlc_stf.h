 ...
 *
 * $Id: wlc_stf.h 531106 2015-02-02 08:44:00Z $
 */
...
extern uint8 get_pwr_from_targets(wlc_info_t *wlc, ratespec_t rspec, ppr_t *txpwr);
extern bool get_cck_override_diversity(wlc_info_t *wlc, ratespec_t rspec);
#endif // endif
