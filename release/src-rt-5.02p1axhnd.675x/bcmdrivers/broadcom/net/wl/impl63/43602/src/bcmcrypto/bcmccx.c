 ...
 *
 * $Id: bcmccx.c 241182 2011-02-17 21:50:03Z $
 */
 ...
 */
void
BCMROMFN(bcm_ccx_hashpwd)(uint8 *pwd, size_t pw_len, uint8 hash[CCX_PW_HASH_LEN],
...
void
BCMROMFN(bcm_ccx_session_key)(uint8 *inbuf, size_t in_len,
...
void
BCMROMFN(bcm_ccx_leap_response)(uint8 pwhash[CCX_PW_HASH_LEN],
...
bool
BCMROMFN(bcm_ckip_rxseq_check)(uint32 seq_odd, uint32 *rxseq_base, uint32 *rxseq_bitmap)
{
