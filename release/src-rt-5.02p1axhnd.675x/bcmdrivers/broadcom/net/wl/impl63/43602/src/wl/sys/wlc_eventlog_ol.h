...
#ifdef BCMDBG
#define	WLC_EL_MAX_EVENTS	(1024)	/* Assume 1K events buffer for DEBUG (~8K) */
#else
#define	WLC_EL_MAX_EVENTS	(256)	/* Assume 256 events buffer for RELEASE (~4KB) */
#endif /* BCMDBG */
