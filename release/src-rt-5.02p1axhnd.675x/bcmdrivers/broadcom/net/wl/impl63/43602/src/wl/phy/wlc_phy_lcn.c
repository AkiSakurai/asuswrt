 ...
 *
 * $Id: wlc_phy_lcn.c 499361 2014-08-28 14:05:21Z $
 */
 ...
 *              clean up ifdef, if LPCONF, LCNCONF
...
wlc_lcnphy_radio_2064_channel_tune(phy_info_t *pi, uint8 channel)
{
	...
	if (logen_5g_valid) {
		mod_radio_reg(pi, RADIO_2064_REG0B0, 0xf0, val_REG0B0 << 4);
		write_radio_reg(pi, RADIO_2064_REG0AF, val_REG0AF);
	}
#endif /* BAND5G */
