 ...
 *
 * $Id: wl_export.h 708652 2017-07-04 04:52:34Z $
 */
...
extern void wl_set_rxoffset_bytes(struct wl_info *wl, uint16 d11rxoffset);
...
#ifdef BCMPCIEDEV
int wlfc_upd_flr_weigth(struct wl_info *wl, uint8 mac_handle, uint8 tid, void* params);
...
extern void wl_wowl_dngldown(struct wl_info *wl, int up_flag);
#define USB_SHUTDOWN 1
#define USB_WAKEUP 2
...
#endif /* DONGLEBUILD */
#if defined(MACOSX) && defined(WLAWDL) && defined(AWDL_FAMILY)
