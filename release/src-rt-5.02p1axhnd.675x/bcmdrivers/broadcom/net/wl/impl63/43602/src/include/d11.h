 ...
 *
 * $Id: d11.h 676722 2016-12-23 10:47:06Z $
 */
...
#define MHF5_AFE_WAR		0x0400		/* Enable fcbs trigger to change afe clock */
...
#define M_BTCX_CRITICAL_MAP_HI (51 * 2)
...
#define M_BTCX_SNIFF_DELAY_LO_LATENCY (84 * 2)
...
#define M_BTCX_NUM_TASKS		(118 * 2) /* legacy usage only in 43242 */
#define M_BTCX_BT_TXPWR		(118 * 2)
#define M_BTCX_PKTABORTCTL_VAL		(119 * 2)
...
#define BTCWAR_NO_A2DP_BFRCHK		(1 << 0);
#define BTCWAR_NO_CCK_RATE		(1 << 1);
#define BTCWAR_NO_OFDM_FB_RATE		(1 << 2);
#define	BTCWAR_NO_INQ_DEFER		(1 << 3);
#define	BTCWAR_ALWAYS_GRANT_BT		(1 << 4);
#define BTCWAR_ANT2WL_NBIT		(1 << 5);

#define M_BTCX_IBSS_TSF_L		(0x3fb * 2)
#define M_BTCX_IBSS_TSF_ML		(0x3fc * 2)
#define M_BTCX_IBSS_TSF_ESCO_L		(0x3fd * 2)
