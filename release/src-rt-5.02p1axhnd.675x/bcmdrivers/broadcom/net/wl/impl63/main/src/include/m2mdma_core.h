...
typedef volatile struct m2m_core_regs {
	...
	uint32 PAD[5];
	m2m_eng_regs_t eng_regs[M2M_CORE_CHANNELS]; /* 0x200 - 0x3f4 */
} m2m_core_regs_t;
...
#define M2M_CORE_CAPABILITIES_CHANNELCNT_MASK \
	BCM_MASK(M2M_CORE_CAPABILITIES_CHANNELCNT)

#define M2M_CORE_CAPABILITIES_MAXBURSTLEN_NBITS 3
#define M2M_CORE_CAPABILITIES_MAXBURSTLEN_SHIFT 4
#define M2M_CORE_CAPABILITIES_MAXBURSTLEN_MASK \
	BCM_MASK(M2M_CORE_CAPABILITIES_MAXBURSTLEN)
...
#define M2M_CORE_CAPABILITIES_SM2MCNT_MASK \
	BCM_MASK(M2M_CORE_CAPABILITIES_SM2MCNT)
