...
#if defined(RTAX86U) || defined(RTAX5700) || defined(RTAX68U)
{{{ 20.5, 15.5, 15.5, 15.5, 15.5, 22.0 }}, {{ 20, 10, 10, 10, 10, 20 }}, {{ 10, 10, 10, 10, 0, 0 }}},	// US, TW
{{{ 20.5, 15.5, 15.5, 0.0, 15.5, 22.0 }}, {{ 20, 10, 10, 0, 10, 20 }}, {{ 10, 10, 0, 0, 0, 0 }}},	// AA
{{{ 10.0, 10.0, 17.0, 0.0, 17.0, 23.0 }}, {{ 20, 10, 10, 0, 10, 20 }}, {{ 15, 15, 0, 0, 0, 0 }}},	// CA
{{{ 9.0, 9.0, 16.0, 16.0, 16.0, 0.0 }}, {{ 20, 20, 20, 0, 0, 0 }}, {{ 10, 10, 10, 0, 0, 0 }}},		// EU
{{{ 13.0, 13.0, 15.5, 15.5, 15.5, 0.0 }}, {{ 10, 5, 5, 5, 0, 0 }}, {{ 5, 5, 5, 5, 0, 0 }}},		// JP
{{{ 14.5, 14.5, 0.0, 0.0, 0.0, 21.0 }}, {{ 20, 10, 0, 0, 0, 20 }}, {{ 10, 10, 0, 0, 0, 0 }}},		// CN
{{{ 14.5, 14.5, 17.0, 17.0, 17.0, 17.0 }}, {{ 10, 5, 5, 5, 0, 10 }}, {{ 5, 5, 5, 5, 0, 0 }}}		// KR
#endif
};
...
acs_candidate_score_txpwr(ch_candidate_t *candi, acs_chaninfo_t* c_info)
{
	...
	ACSD_INFO("txpwr score: %d for chanspec 0x%4x (%s)\n", score, chspec,
