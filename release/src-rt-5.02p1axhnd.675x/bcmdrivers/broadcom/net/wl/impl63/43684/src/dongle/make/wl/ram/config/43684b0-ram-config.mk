...
BASE_FW_IMAGE		:= pcie-splitrx-mfp-pktctx-amsdutx-ampduretry-ringer-dmaindex16-txbf-hostpmac-dhdhdr-avs-cu-vasip-ampduhostreorder-murx-wrr-sae-swprbrsp

# FDAP features
FDAP_FEATURES		:= fdap-mbss-wl11k-wl11u-wnm-chanim-bgdfs-cevent-pspretend-stamon-fbt-osen-obss-dbwsw-mbo-mutx-cca-ccamesh-map-splitassoc-led-slvradar-atm-memallocstats-dpp-dtpc
