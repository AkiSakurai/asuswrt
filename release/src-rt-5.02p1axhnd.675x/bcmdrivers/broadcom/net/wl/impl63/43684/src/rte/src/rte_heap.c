 ...
 *
 * $Id: rte_heap.c 778904 2019-09-13 12:15:02Z $
 */
...
/* store last DBG_MEM_HIST_SIZE malloc and free callers */
#define DBG_MEM_HIST_SIZE 256
typedef struct dbg_mem_hist {
	uchar		*caller;
	int32		size;
	uchar		*ptr;
} dbg_mem_hist_t;
static uint g_malloc_hist_idx = 0;
static dbg_mem_hist_t g_malloc_hist_list[DBG_MEM_HIST_SIZE];
static uint g_free_hist_idx = 0;
static dbg_mem_hist_t g_free_hist_list[DBG_MEM_HIST_SIZE];
...
#if defined(BCMDBG_MEM)
	g_malloc_hist_list[g_malloc_hist_idx].caller = call_site;
	g_malloc_hist_list[g_malloc_hist_idx].size = size;
	g_malloc_hist_list[g_malloc_hist_idx].ptr = ptr;
	g_malloc_hist_idx = MODINC_POW2(g_malloc_hist_idx, DBG_MEM_HIST_SIZE);
#endif /* BCMDBG_MEM */
...
#if defined(BCMDBG_MEM)
	g_free_hist_list[g_free_hist_idx].caller = CALL_SITE;
	g_free_hist_list[g_free_hist_idx].size = free_size;
	g_free_hist_list[g_free_hist_idx].ptr = where;
	g_free_hist_idx = MODINC_POW2(g_free_hist_idx, DBG_MEM_HIST_SIZE);
#endif /* BCMDBG_MEM */
