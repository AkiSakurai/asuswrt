...
#if defined(WLBSSLOAD) && !defined(WLBSSLOAD_DISABLED)
	wlc->pub->_bssload = TRUE;
#endif /* WLBSSLOAD && !WLBSSLOAD_DISABLED */

#if defined(STA) && defined(WLBSSLOAD_REPORT) && !defined(WLBSSLOAD_REPORT_DISABLED)
	wlc->pub->_bssload_report = TRUE;
#endif /* defined(STA) && defined(WLBSSLOAD_REPORT) && !defined(WLBSSLOAD_REPORT_DISABLED) */
