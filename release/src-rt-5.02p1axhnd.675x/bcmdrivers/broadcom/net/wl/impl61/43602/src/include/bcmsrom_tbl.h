 ...
 *
 * $Id: bcmsrom_tbl.h 542712 2015-03-20 19:12:39Z $
 */
...
#ifdef SROM12
	/* Unlike other srom revs, SROM 12 is incompatible with other revs.
	 * _initvars_srom_pci() skips/drops fields with bits for srom revs other than 12.
	 * So if an entry is not marked *only* for rev12, it gets dropped.
	 */
#if defined(DSLCPE) && defined(DSLCPE_WOMBO)
	{"devid",	0x00001000,	SRFL_PRHEX|SRFL_PCI, SROM_DEVID_PCI, 0xffff},
	{"devid",	0x00001000,	SRFL_PRHEX|SRFL_PCIE, SROM_DEVID_PCIE, 0xffff},
#elif defined(CABLECPE)
	{"devid",	0x00001000,	SRFL_PRHEX,	PCI_F0DEVID,	0xffff},
#elif defined(BCMPCIEDEV) && defined(BCMPCIEDEV_ENABLED)
