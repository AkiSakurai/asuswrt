 ...
 *
 * $Id: wlc_pub.h 720035 2017-09-07 13:43:21Z $
 */
...
#endif /* BCMWAPI_WAI */
#if defined(BCMCCX) || defined(WLP2P) || defined(WLMCHAN)
...
typedef struct wlc_pub {
...
#endif // endif
#if defined(WLBSSLOAD) && !defined(WLBSSLOAD_ROM_COMPACT)
	/* Relocate struct field that are mismatched in ROM stat table */
	...
	bool		_probresp_sw;
#endif // endif
#if defined(BCMWAPI_WPI) || defined(BCMWAPI_WPI_COMPAT)
...
#define WLC_PUB_WL_OKC_FIELD \
	...
	bool		_mbss_support;		/* MBSS support */
#if defined(WLBSSLOAD) && defined(WLBSSLOAD_ROM_COMPACT)
	/* Relocate struct field that are mismatched in ROM stat table */
	bool		_bssload;		/* bss load IE */
#endif // endif
...
#ifdef WL_SHIF
	bool		_shub;			/* enable/disable sensor hub interface */
#endif /* WL_SHIF */
	...
	bool		_scb_alloc;		/* scb alloc enable bool */
...
/* The next 2 definitions are overloaded with the above,
 * there is currently no scope for collision
 */
#define WLF_RXPKTFETCH_CHECK_DONE 0x00010000	/* pkt already checked for pktfetch requirements */
#define WLF_NEED_RXPKTFETCH	0x00020000	/* pkt has been marked as needing pktfetch */
...
#define WLF_RX_PKTC_NOTFIRST	0x00200000	/* not the first pkt in chain */
#define WLF_RX_PKTC_NOTLAST	0x00400000	/* not the last pkt in chain */
#define WLF_RX_PKTC_ISREPLAY	0x00200000	/* is replay */
...
#define WLF2_PCB1_NAN		7	/* nan_mac_txstatus */
...
#endif /* WLOLPC */
#define WLF2_PCB1_AIBSS_DATA	12	/* AIBSS TX packets */
#ifdef WLPROBRESP_INTRANSIT_FILTER
#define WLF2_PCB1_PROBRESP	13	/* wlc_proberesp_cb */
...
/* PKTTAG(p)->_scb points to memory, which points to SCB */
#define WLPKTTAGSCBGET(p)	((WLPKTTAG(p)->_scb) ? (*(struct scb **)(WLPKTTAG(p)->_scb)) : NULL)
#define WLPKTTAGSCBCLR(p)	(WLPKTTAG(p)->_scb = NULL)
#define WLPKTTAGSCBSET(p, scbd)	((scbd) ? (WLPKTTAG(p)->_scb = (scbd)->scb_addr): WLPKTTAGSCBCLR(p))
#else
...
#ifdef BCM_HOST_MEM_SCB
	#define SCB_ALLOC_ENAB(pub)		((pub)->_scb_alloc)
#else
	#define SCB_ALLOC_ENAB(pub)			(0)
#endif /* BCM_HOST_MEM_SCB */
...
/* proptxstatus feature dynamic enable, compile time enable or disable */
...
#if defined(METADATA_TO_HOST)
	#if defined(WL_ENAB_RUNTIME_CHECK) || !defined(DONGLEBUILD)
		#define METADATA_TO_HOST_ENAB(pub)	((pub)->_metadata_to_host)
	#elif defined(METADATA_TO_HOST_DISABLED)
		#define METADATA_TO_HOST_ENAB(pub)	0
	#else
		#define METADATA_TO_HOST_ENAB(pub)	1
	#endif
#else
	#define METADATA_TO_HOST_ENAB(pub)	0
	...
	#if defined(WL_ENAB_RUNTIME_CHECK) || !defined(DONGLEBUILD)
		#define CREDIT_INFO_UPDATE_ENAB(pub)	((pub)->_credit_info_update)
	#elif defined(CREDIT_INFO_UPDATE_DISABLED)
		#define CREDIT_INFO_UPDATE_ENAB(pub)	0
	#else
		#define CREDIT_INFO_UPDATE_ENAB(pub)	1
	#endif
#else
	#define CREDIT_INFO_UPDATE_ENAB(pub)	0
...
/* WLDPT Support */
		...
		#define DPT_ENAB(pub) ((void)(pub), 1)
	#else
...
#ifdef EXT_STA
	#if defined(NDIS)
		#define EXTSTA_ENAB(pub)	WLEXTSTA_ENAB(pub)
	#else
		#define EXTSTA_ENAB(pub)	WIN7_AND_UP_OS(pub)
	#endif
#else
	#define EXTSTA_ENAB(pub)		(0)
#endif /* EXT_STA */
...
/* Host clock sync */
#if defined(WL_HOST_CLK_SYNC)
#define HOSTCLKSYNC_ENAB(pub)   (1)
#elif !defined(WL_HOST_CLK_SYNC)
#define HOSTCLKSYNC_ENAB(pub)   (0)
#else /* Need runtime check */
#define HOSTCLKSYNC_ENAB(pub)   ((pub)->_hostclksync)
#endif /* defined(WL_HOST_CLK_SYNC) */
...
#ifdef WL_SHIF
	#if defined(WL_ENAB_RUNTIME_CHECK)
		#define SHIF_ENAB(pub)   ((pub)->_shub)
...
#else
	#define WLC_PROT_OBSS_ENAB(pub) (0)
#endif /* defined(WL_PROT_OBSS) */

/* OBSS DYNBW switching support */
#if defined(WL_PROT_DYNBW)
	#if defined(WL_ENAB_RUNTIME_CHECK) || !defined(DONGLEBUILD)
		#define WLC_PROT_DYNBW_ENAB(pub) ((pub)->_prot_obss)
	#elif defined(WL_PROT_DYNBW_DISABLED)
		#define WLC_PROT_DYNBW_ENAB(pub) (0)
	#else
		#define WLC_PROT_DYNBW_ENAB(pub) ((pub)->_prot_obss)
	#endif
#else
	#define WLC_PROT_DYNBW_ENAB(pub) (0)
#endif /* defined(WL_PROT_DYNBW) */
...
/* txpwr1 setting per band support. */
#ifdef WLTXPWR_PER_BAND
	#if defined(WL_ENAB_RUNTIME_CHECK)
		#define WLTXPWR_PER_BAND_ENAB(pub)	((pub)->_txpwr_per_band)
	#elif defined(WLTXPWR_PER_BAND_DISABLED)
		#define WLTXPWR_PER_BAND_ENAB(pub)	(0)
	#else
		#define WLTXPWR_PER_BAND_ENAB(pub)	(1)
	#endif
#else
	#define WLTXPWR_PER_BAND_ENAB(pub)		(0)
