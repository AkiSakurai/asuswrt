 ...
 *
 * $Id: wlc_cfg.h 744706 2018-02-05 09:12:35Z $
 */
...
#define D11_DEFAULT2	0x000fffa7	/* Supported  D11 revs: 32-34, 37, 39, 40-49 */
...
#define ACPHY_DEFAULT		0x007ebff       /* Supported acphy revs:
						 *	0	4360a0
						 *	1	4360b1
						 *	2	4335a0
						 *	3	4350a0/b0/b1
...
#if defined(WLDPT)
#if !defined(STA) || !defined(BCMSUP_PSK) || !defined(BCMAUTH_PSK)
...
#define MAXSCBCUBBIES		28	/* max number of cubbies in scb container */
#endif /* MAXSCBCUBBIES */
...
#define MAX_NOTIF_SERVERS	(14+IDSUP_NOTIF_SRVR_OBJS)
#endif // endif

/* Maximum number of notification clients. */
#ifndef MAX_NOTIF_CLIENTS
#define MAX_NOTIF_CLIENTS	(22+IDSUP_NOTIF_CLNT_OBJS)
#endif // endif
...
#define IS_DEV_AC2X2(d) (((d) == BCM4352_D11AC_ID) ||	\
	                 ...
	                 ((d) == BCM43567_D11AC_ID) || \
	                 ((d) == BCM43567_D11AC2G_ID) || \
	                 ((d) == BCM43567_D11AC5G_ID) || \
	                 ((d) == BCM43568_D11AC_ID) || \
	                 ((d) == BCM43568_D11AC2G_ID) || \
	                 ((d) == BCM43568_D11AC5G_ID) || \
	                 ((d) == BCM43570_D11AC_ID) || \
	                 ((d) == BCM43570_D11AC2G_ID) || \
	                 ((d) == BCM43570_D11AC5G_ID) || \
	                 ((d) == BCM4354_D11AC_ID) || \
