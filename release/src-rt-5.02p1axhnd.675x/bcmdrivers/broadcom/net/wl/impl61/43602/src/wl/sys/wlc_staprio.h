...
#define STAPRIO_BSSCFG_PRIVATE	0x0
#define STAPRIO_BSSCFG_PUBLIC	0x1
#define STAPRIO_BSSCFG_VIDEO	0x2

#define STAPRIO_BSSCFG_IS_PUBLIC(class) (class == STAPRIO_BSSCFG_PUBLIC)
#define STAPRIO_BSSCFG_IS_PRIVATE(class) (class == STAPRIO_BSSCFG_PRIVATE)
#define STAPRIO_BSSCFG_IS_VIDEO(class) (class == STAPRIO_BSSCFG_VIDEO)
