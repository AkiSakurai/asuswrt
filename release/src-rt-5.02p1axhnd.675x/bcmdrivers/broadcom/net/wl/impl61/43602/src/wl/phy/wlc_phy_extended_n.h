...
#define NPHY_NOISE_NOASSOC_ENTER_TH_REV19_4324x_EPA 600
#define NPHY_NOISE_NOASSOC_EXIT_TH_REV19_4324x_EPA  100
...
#define NPHY_NOISE_ASSOC_ENTER_TH_REV19_4324x_EPA  400
#define NPHY_NOISE_ASSOC_EXIT_TH_REV19_4324x_EPA  100
...
#define BPHY_DESENSE_NOISE_ENTER_TH_4324X_EPA	150
#define BPHY_DESENSE_NOISE_EXIT_TH_4324X_EPA	80
...
#define NOISE_MITI_BPHY_CRSMIN_DECR_MAX_4324X_EPA 16
#define NOISE_MITI_BPHY_NOASSOC_CRSMIN_DECR_MAX_4324X_EPA 32
#define BPHY_CRSMINPWR_MIN_4324X_EPA 0x46
#define NOISE_MITI_BPHY_CRSMINPWR_INCR_4324X_EPA 16
#define BPHY_CRSMINPWR_MAX_4324X_EPA 0x9f
#endif // endif
#endif /* Check for BPHY_DESENSE */

/* 4324x crsminpower related parameters */
#ifdef EPA_CHIP_4324X
#define NOISE_MITI_CRSMINPWR_INCR_4324X_EPA 8
#define CRSMINPWR_MAX_4324X 127
/* min_crsminpwr = 8*log2(16*min_cmplx_pwr) + Koffset  = 32 + 12 = 44 */
#define CRSMINPWR_MIN_4324X_EPA (32 + MIN (pi->sh->noisecaloffset, pi->sh->noisecaloffset5g))
#define NOISE_MITI_CRSMIN_DECR_MAX_4324X_EPA 16
#define NM_ROBUSTNESS_WINDOW_4324X_EPA 5
#define NM_ROBUSTNESS_NOISE_VARIATION_THRESH_4324X_EPA 3
#define NOISE_MITI_RSSI_TO_CRS_GAIN_OFFSET_4324X_EPA 12
#endif // endif
...
/* rdar:13468328: limit changed for 4324x_epa_family */
#define NPHY_NPWR_MAXLMT_2G_4324X_EPA 800
...
/* rdar:13468328: limit changed for 4324x_epa_family */
#define NPHY_NPWR_MAXLMT_5G_4324x_EPA 800
...
/* rdar:13468328: limit changed for 4324x_epa_family */
#define NPHY_MAX_RXPO_CHANGE_LMT_2G_4324X 60
#define NPHY_MAX_RXPO_CHANGE_LMT_5G 16
/* rdar:13468328: limit changed for 4324x_epa_family */
#define NPHY_MAX_RXPO_CHANGE_LMT_5G_4324X 60
#define CRSMINPWR_BASELINE_4324x_2G	0x46
#define CRSMINPWR_BASELINE_4324x_5G	0x3d
#define CRSMIN_RIFS_DISABLE_THRESH_4324x_EPA 0x50
