 ...
 *
 * $Id: bcmcdc.c 503290 2014-09-18 04:46:08Z $
 */
 ...
 */
void *
BCMINITFN(proto_attach)(osl_t *osh, struct dngl *dngl, struct dngl_bus *bus,
...
void
BCMATTACHFN(proto_detach)(void *proto)
{
...
void
proto_ctrldispatch(void *proto, void *p, uchar *ext_buf)
{
	cdc_info_t *cdc = (cdc_info_t *) proto;
		...
		if (savelen) {
			...
			if (savebuf != NULL) {
				...
				for (newpkt = p; remlen > 0; remlen -= segsize) {
					...
					tmp_pkt = PKTGET(cdc->osh, segsize, TRUE);
					PKTSETNEXT(cdc->osh, newpkt, tmp_pkt);
...
void *
proto_pkt_header_push(void *proto, void *p)
{
...
int
proto_pkt_header_pull(void *proto, void *p)
{
	cdc_info_t *cdc = proto;
	struct bdc_header *h;
	osl_t *osh = cdc->osh;
...
void
proto_dev_event(void *proto, void *data)
{
#ifdef NOTYET
	cdc_info_t *cdc = (cdc_info_t *) proto;
