 ...
 *
 * $Id: rtecdc.c 687024 2017-02-27 06:01:22Z $
 */
...
BCMATTACHFN(c_init)(void)
{
	...
	event_log_init(sih);
	/* WL LOG */
	event_log_set_init(sih, EVENT_LOG_SET_WL, EVENT_LOG_WL_BLOCK_SIZE);
	event_log_set_expand(sih, EVENT_LOG_SET_WL, EVENT_LOG_WL_BLOCK_SIZE);
	  /* BUS LOG */
