 ...
 *
 * $Id: wlc_phy_hal.h 676722 2016-12-23 10:47:06Z $
 */
...
#define PHY_PERICAL_TEMP_ONLY   0     /* Temperature based PHY calibrations only */
...
#define PHY_PERICAL_DELAY_EU            60      /* delay(ms) between cals in mphase if REGION_EU */
...
#define PHY_CAP_QAM256_5G 	0x00000200	/* Support for 256QAM */
#define PHY_CAP_QAM256_24G 	0x00000400	/* Support for 256QAM */
...
/* add wlc_phydump_phyaci to WLTEST for mfgtest */
#define PHYACI_DMP_FOR_MFGTEST
...
enum {
	...
	IOV_PHY_INTERFERENCE_OVERRIDE2,
...
extern int  wlc_phy_txpower_get_a(wlc_phy_t *ppi, int8 *qdbm, bool *override);
extern int  wlc_phy_txpower_set_offset(wlc_phy_t *ppi, int8 *qdbm);
#ifdef WLTXPWR_PER_CORE
extern int  wlc_phy_txpower_set(wlc_phy_t *ppi, int8 *qdbm, bool override, ppr_t *reg_pwr);
extern int  wlc_phy_neg_txpower_set(wlc_phy_t *ppi, int8 *qdbm);
#else
extern int  wlc_phy_txpower_set(wlc_phy_t *ppi, int8 qdbm, bool override, ppr_t *reg_pwr);
...
extern int wlc_phyhal_txpwrcap_get_cellstatus(wlc_phy_t *pi);
extern void wlc_phyhal_txpwrcap_set_cellstatus(wlc_phy_t *pi, int cellstatus);
...
extern void wlc_acphy_set_ldo(wlc_phy_t *ppi, uint8 ldostatus);
extern bool wlc_phy_get_2069_xtalldowar_status(wlc_phy_t *ppi);
#endif // endif

extern void wlc_phy_btc_simrx(wlc_phy_t *ppi, bool set);
#ifdef WLOLPC
extern int8 wlc_phy_calc_ppr_pwr_cap(wlc_phy_t *pih, uint8 core);
#endif /* WLOLPC */
#endif	/* _wlc_phy_h_ */
