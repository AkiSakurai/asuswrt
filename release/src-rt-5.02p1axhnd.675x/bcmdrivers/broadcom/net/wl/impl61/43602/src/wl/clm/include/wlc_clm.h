 ...
 *
 * $Id: wlc_clm.h 514041 2014-11-08 10:50:30Z $
 */
...
typedef enum clm_string_type {
	...
	/** Name and version of program that generfated XML */
	CLM_STRING_TYPE_GENERATOR_VERSION,

	/** Enginneering version of CLM data */
...
typedef enum clm_string_source {
	...
	/** If incremental data present - string stored in it otherwise in base data */
...
typedef struct clm_limits_params {
	 ...
	 * for which per-antenna power limits specified. If 2 limits specified - they'll be
	 * returned for antenna indices 0 and 1, WL_RATE_DISABLED will be returned for antenna
	 * index 3. If 3 limits specified - they'll be returned for corresponded antenna indices.
	 * Default is 0
	 */
	int antenna_idx;
...
#ifdef WL11DFSTW
#define clm_country_flags clm_country_flags_shim
#endif /* WL11DFSTW */
#endif /* !CLM_NO_SHIM */
