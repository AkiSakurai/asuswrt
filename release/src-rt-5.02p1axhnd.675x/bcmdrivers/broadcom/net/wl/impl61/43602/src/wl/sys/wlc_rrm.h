 ...
 *
 * $Id: wlc_rrm.h 674609 2016-12-09 16:03:42Z $
 */
...
#endif // endif
#else
#define wlc_rrm_stat_qos_counter(scb, tid, cnt_offset)	do {BCM_REFERENCE(tid);} while (0)
#define wlc_rrm_stat_bw_counter(wlc, scb, tx)		do {} while (0)
#define wlc_rrm_stat_chanwidthsw_counter(wlc, cfg)	do {} while (0)
#define rrm_add_pilot_timer(wlc, cfg)			do {} while (0)
