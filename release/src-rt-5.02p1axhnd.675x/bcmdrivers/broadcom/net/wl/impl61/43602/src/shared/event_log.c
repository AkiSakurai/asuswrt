 ...
 * special overlay sections. This means that the EVENT_LOG 'fmt_num' values linked in ROM
 * are incorrect. This is a work-around to fix the 'fmt_num' values recorded in EVENT_LOG
 * buffers.
 */
