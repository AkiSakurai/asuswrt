...
/* Normal Downgrade  */
	...
	uint32 DN_Drain_Start_time;
	uint32 DN_Drain_End_time;
...
extern void wlc_modesw_clear_phy_chanctx(wlc_info_t *wlc, wlc_bsscfg_t *cfg);
extern bool wlc_modesw_update_bandwidth(wlc_info_t * wlc, wlc_bsscfg_t * bsscfg,
	chanspec_t new_chspec);
extern bool wlc_modesw_update_bw_pending(wlc_info_t * wlc, wlc_bsscfg_t * bsscfg);
extern void
