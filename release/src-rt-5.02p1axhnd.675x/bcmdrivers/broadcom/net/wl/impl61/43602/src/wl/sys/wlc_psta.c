 ...
 *
 * $Id: wlc_psta.c 769206 2018-11-06 10:38:14Z $
 */
...
static int wlc_psta_doiovar(void *hdl, const bcm_iovar_t *vi, uint32 actionid,
                 ...
                 void *p, uint plen, void *a, int32 alen, int vsize, struct wlc_if *wlcif)
{
	...
	bool bool_val;
	psta_bsscfg_cubby_t *psta_cfg;
#if defined(BCMDBG) || !defined(PSTA_IN_43602a1_ROM)
	char eabuf[ETHER_ADDR_STR_LEN];
#endif // endif
#ifndef PSTA_IN_43602a1_ROM
	BCM_REFERENCE(eabuf);
#endif // endif
