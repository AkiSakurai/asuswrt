 ...
 *
 * $Id: wl_cfg_btcoex.c 465194 2014-03-26 23:00:33Z $
 */
...
int wl_cfg80211_set_btcoex_dhcp(struct net_device *dev, dhd_pub_t *dhd, char *command)
{
	...
	if (strnicmp((char *)&powermode_val, "1", strlen("1")) == 0) {
		CFG80211_TRACE_HW4(("DHCP session starts\n"));
		...
		if (dhd->early_suspended) {
			CFG80211_TRACE_HW4(("DHCP in progressing , disable packet filter!!!\n"));
		...
		CFG80211_TRACE_HW4(("DHCP is complete \n"));

		/* Enable packet filtering */
		if (dhd->early_suspended) {
			CFG80211_TRACE_HW4(("DHCP is complete , enable packet filter!!!\n"));
