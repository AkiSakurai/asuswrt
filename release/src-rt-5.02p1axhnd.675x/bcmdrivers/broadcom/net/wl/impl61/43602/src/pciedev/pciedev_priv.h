...
#define PCIEDEV_WATCHDOG_TIMEOUT	1000
...
#define FLOW_RING_PKT_IDLE (1 << 9)
#define FLOW_RING_FETCH_SKIPPED (1 << 10)
...
#define PCIEDEV_MIN_SHCEDLFRAG_COUNT	32
...
#define PCIEDEV_FETCH_CNT_THRESHOLD	32
#define PCIEDEV_PKTINFLIGHT_WATERMARK	32
...
struct dngl_bus {
	...
	/* Scheduler context */
	/* the sum of weight of all pending flowrings per scheduling cycle */
	...
	dngl_timer_t	*wd_timer;
	uint32	single_amsdu_fetch; /* No. of Single AMSDU suppressed packet fetch */
	uint32	single_amsdu_fetch_reject; /* No. of AMSDU suppressed packet fetch rejected */
	...
	struct {
		...
		uint32 pciedev_resource_avail_for_txmetadata;
		...
		uint32 pciedev_get_lclbuf_pool;
