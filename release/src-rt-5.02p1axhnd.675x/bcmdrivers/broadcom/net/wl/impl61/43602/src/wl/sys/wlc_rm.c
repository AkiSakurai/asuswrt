 ...
 *
 * $Id: wlc_rm.c 456199 2014-02-18 03:06:41Z $
 */
...
static int wlc_rm_abort_ioctl(rm_info_t *rm_info);
...
static const bcm_iovar_t rm_iovars[] = {
	...
	{"rm_abort", IOV_RM_ABORT, 0, IOVT_VOID, 0},
	{NULL, 0, 0, 0, 0}
};
	...
	void *params, uint plen, void *arg, int len, int val_size, struct wlc_if *wlcif)
{
	...
	case IOV_SVAL(IOV_RM_ABORT):
		err = wlc_rm_abort_ioctl(rm_info);
		break;
...
static int
wlc_rm_abort_ioctl(rm_info_t *rm_info)
{
	wlc_info_t *wlc = rm_info->wlc;
