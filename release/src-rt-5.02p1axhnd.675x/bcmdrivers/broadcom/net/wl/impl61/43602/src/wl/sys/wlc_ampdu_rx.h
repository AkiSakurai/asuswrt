 ...
 *
 * $Id: wlc_ampdu_rx.h 676784 2016-12-24 16:10:17Z $
*/
...
typedef struct bsscfg_ampdu_rx bsscfg_ampdu_rx_t;
...
extern void wlc_ampdu_rx_cleanup_all(ampdu_rx_info_t *ampdu_rx);
extern int wlc_ampdu_rx_set(ampdu_rx_info_t *ampdu_rx, bool on);
extern void wlc_ampdu_agg_state_update_rx_override(wlc_info_t *wlc,
	wlc_bsscfg_t *bsscfg, int8 rxaggr);
extern void wlc_ampdu_agg_state_update_rx(wlc_info_t *wlc, wlc_bsscfg_t *bsscfg,
	bool rxaggr, uint16 conf_TID_bmap);
#ifdef WLAMSDU
extern void wlc_ampdu_set_rx_amsdu_override(wlc_info_t *wlc, wlc_bsscfg_t *bsscfg, bool ovrd);
#endif // endif
...
extern void BCMATTACHFN(wlc_ampdu_agg_rxaggr_support)(ampdu_rx_info_t *ampdu_rx,
	int8 rxaggr);
