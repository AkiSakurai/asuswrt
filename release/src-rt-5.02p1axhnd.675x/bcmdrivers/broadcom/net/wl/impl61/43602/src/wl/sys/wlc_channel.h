 ...
 *
 * $Id: wlc_channel.h 767335 2018-09-06 06:09:41Z $
 */
...
extern bool wlc_sta_supports_global_rclass(struct wlc_info *wlc, uint8 *setBitBuff, uint8 *flag);
extern uint8 wlc_channel_get_cur_rclass(struct wlc_info *wlc);
extern void wlc_channel_set_cur_rclass(struct wlc_info *wlc, uint8 cur_rclass);
