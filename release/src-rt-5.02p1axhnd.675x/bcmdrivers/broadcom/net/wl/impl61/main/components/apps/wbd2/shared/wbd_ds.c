 ...
 *
 * $Id: wbd_ds.c 782695 2020-01-02 04:56:38Z $
 */
...
wbd_ds_interface_deinit(i5_dm_interface_type *i5_ifr)
{
	...
	if (i5_ifr->vndr_data) {
		if (((wbd_ifr_item_t*)(i5_ifr->vndr_data))->chan_info) {
			free(((wbd_ifr_item_t*)(i5_ifr->vndr_data))->chan_info);
		}
		((wbd_ifr_item_t*)(i5_ifr->vndr_data))->chan_info = NULL;
