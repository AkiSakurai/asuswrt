 ...
 *
 * $Id: phy_ac_rxspur.c 783064 2020-01-13 13:58:03Z $
 */
...
static const uint32 acphy_spurcan_spur_freqKHz_rev128[] = {2425000, 2450000, 2475000,
	5200000, 5300000, 5400000, 5500000, 5600000, 5700000, 5750000, 5754350, 5800000};
...
phy_ac_spurcan(phy_ac_rxspur_info_t *rxspuri, bool enable)
{
	...
	} else if (spurfreq != NULL || tbl_len_vco > 0) {
