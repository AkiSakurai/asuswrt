...
#define BME_DMATMPL_NOTPCIEDP_MASK \
	BITMASK(BME_DMATMPL_NOTPCIEDP_NBITS, BME_DMATMPL_NOTPCIEDP_SHIFT)
#define BME_DMATMPL_COHERENTDP_MASK \
	BITMASK(BME_DMATMPL_COHERENTDP_NBITS, BME_DMATMPL_COHERENTDP_SHIFT)
#define BME_DMATMPL_ADDREXTDP_MASK \
	BITMASK(BME_DMATMPL_ADDREXTDP_NBITS, BME_DMATMPL_ADDREXTDP_SHIFT)
#define BME_DMATMPL_NOTPCIESP_MASK \
	BITMASK(BME_DMATMPL_NOTPCIESP_NBITS, BME_DMATMPL_NOTPCIESP_SHIFT)
#define BME_DMATMPL_COHERENTSP_MASK \
	BITMASK(BME_DMATMPL_COHERENTSP_NBITS, BME_DMATMPL_COHERENTSP_SHIFT)
#define BME_DMATMPL_PERDESCWC_MASK \
	BITMASK(BME_DMATMPL_PERDESCWC_NBITS, BME_DMATMPL_PERDESCWC_SHIFT)

#define BME_STS_CTL_STATUS_SIZE_NBITS 8
#define BME_STS_CTL_STATUS_SIZE_SHIFT 22
#define BME_STS_CTL_STATUS_SIZE_MASK \
	BITMASK(BME_STS_CTL_STATUS_SIZE_NBITS, BME_STS_CTL_STATUS_SIZE_SHIFT)
