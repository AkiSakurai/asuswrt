...
#define HWA_PP_CMD_TRANS_MASK       7
...
// Pre allocate lbuf.
#define HWA_PP_LBUF_POOL_LEN_MAX	8
typedef struct hwa_pp_lbuf_pool
{
	...
	uint8  trans_id; // closed REQ/RSP transaction
} hwa_pp_rxlbuf_pool_t, hwa_pp_txlbuf_pool_t;
