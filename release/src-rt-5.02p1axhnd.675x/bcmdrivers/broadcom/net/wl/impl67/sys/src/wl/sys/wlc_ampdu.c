 ...
 *
 * $Id: wlc_ampdu.c 791185 2020-09-18 12:09:27Z $
 */
...
#if defined(RAVG_SIMPLE) || !defined(DONGLEBUILD)
	int i;
#endif /* RAVG_SIMPLE || !DONGLEBUILD */
...
#ifdef WLTAF
	wlc_taf_txpkt_status(wlc->taf_handle, scb, ini->tid, pkt, TAF_TXPKT_STATUS_PKTFREE);
#endif // endif
...
#endif // endif
#ifdef WLTAF
			wlc_taf_txpkt_status(ampdu_tx->wlc->taf_handle, scb, ini->tid, p,
	...
	void *p, tx_status_t *txs, wlc_txh_info_t *txh_info)
{
	...
	ASSERT(ini->scb == scb);
#ifdef WLTAF
	wlc_taf_txpkt_status(wlc->taf_handle, scb, ini->tid, p, TAF_TXPKT_STATUS_REGMPDU);
#endif // endif
	seq = txh_info->seq;
