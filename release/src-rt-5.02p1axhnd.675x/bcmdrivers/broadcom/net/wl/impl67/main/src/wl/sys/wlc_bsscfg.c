 ...
 *
 * $Id: wlc_bsscfg.c 790740 2020-09-01 21:44:50Z $
 */
...
extern void wl_set_dwds_client(struct wl_if *wlif, bool set);
#endif // endif
...
#if defined(BCM_PKTFWD)
	if (bsscfg->wlcif)
		wl_set_dwds_client(bsscfg->wlcif->wlif, FALSE);
#endif /* BCM_PKTFWD */
...
#if defined(BCM_PKTFWD)
	if (bsscfg->wlcif)
		wl_set_dwds_client(bsscfg->wlcif->wlif, TRUE);
#endif /* BCM_PKTFWD */
