 ...
 *
 * $Id: phy_papdcal_iov.c 787578 2020-06-04 01:28:31Z $
 */
...
static const bcm_iovar_t phy_papdcal_iovars[] = {
	...
	{"phy_papd_ipaofftime", IOV_PHY_PAPD_IPAOFF, (IOVF_GET_UP | IOVF_MFG), 0, IOVT_UINT32, 0},
	{"phy_papd_cts2self", IOV_PHY_PAPD_CTS2SELF, (IOVF_GET_UP | IOVF_MFG), 0, IOVT_UINT32, 0},
#endif // endif
	...
	void *p, uint plen, void *a, uint alen, uint vsize, struct wlc_if *wlcif)
{
	...
	switch (aid) {
		...
		case IOV_GVAL(IOV_PHY_PAPD_IPAOFF):
			err = phy_papdcal_get_ipaoff(pi, ret_int_ptr);
			break;

		case IOV_SVAL(IOV_PHY_PAPD_IPAOFF):
			err = phy_papdcal_set_ipaoff(pi, (int32)int_val);
			break;

		case IOV_GVAL(IOV_PHY_PAPD_CTS2SELF):
			err = phy_papdcal_get_cts2self(pi, ret_int_ptr);
			break;

		case IOV_SVAL(IOV_PHY_PAPD_CTS2SELF):
			err = phy_papdcal_set_cts2self(pi, (int32)int_val);
			break;
#endif // endif
#if defined(WLTEST) || defined(DBG_PHY_IOV) || defined(WFD_PHY_LL_DEBUG) || \
	defined(ATE_BUILD)
