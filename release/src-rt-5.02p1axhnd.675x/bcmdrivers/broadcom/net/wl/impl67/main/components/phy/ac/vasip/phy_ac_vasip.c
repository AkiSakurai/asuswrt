 ...
 *
 * $Id: phy_ac_vasip.c 787233 2020-05-22 00:54:14Z $
 */
...
static void phy_ac_dump_svmp(phy_type_vasip_ctx_t *ctx, struct bcmstrbuf *b)
{
	...
	static const svmp_list_t svmpmems_2x2[] = {
		...
		{0x8000, 0x20},         /* TXV_IDX = 64 */
		{0x8800, 0x20},         /* TXV_IDX = 65 */
		{0x9000, 0x20},         /* TXV_IDX = 66 */
		{0x9800, 0x20}          /* TXV_IDX = 67 */
	};
	static const svmp_list_t svmpmems_3x3[] = {
		...
		{0x8400, 0x20},         /* TXV_IDX = 64 */
		{0x9600, 0x20},         /* TXV_IDX = 65 */
		{0xa800, 0x20},         /* TXV_IDX = 66 */
		{0xba00, 0x20}          /* TXV_IDX = 67 */
	};
