/*
 * Broadcom 802.11 Networking Device Driver Configuration file for 6715a0
 *
 ...
 * $Id: $
 *
 * wl driver tunables for 6715a0 RTE dev
 *
 */
...
#define HWACONF		0x00000008	/* HWA Core Rev 131 */
...
#define MAXSCB		64 /* max # of SCB that can be supported based on memory available */
