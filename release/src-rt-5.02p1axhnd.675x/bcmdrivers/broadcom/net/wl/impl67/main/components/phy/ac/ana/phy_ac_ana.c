 ...
 *
 * $Id: phy_ac_ana.c 786127 2020-04-17 04:52:26Z $
 */
...
static const swctrlmap4_mode_t femctrl_mapping[3][SWCTRLMAP4_FEMCTRL_TBL_MAP_LEN] = {
	{
		MISC, MISC, RX, RXBYP,
		MISC, MISC, RX, RXBYP,
		MISC, TX, MISC, TX,
...
wlc_phy_write_femctrl_table_swctrlmap4(phy_info_t *pi)
{
	...
	FOREACH_CORE(pi, core) {
		/* If misc contains epapd loopback settings */
		if (swctrl->misc_usage == 2) {
			swctrl->epapd2g[core] = swctrl->misc2g[core];
			swctrl->epapd5g[core] = swctrl->misc5g[core];
		} else {
			swctrl->epapd2g[core] = 0;
			swctrl->epapd5g[core] = 0;
		}
