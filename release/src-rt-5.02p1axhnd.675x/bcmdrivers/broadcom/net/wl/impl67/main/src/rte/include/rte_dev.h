 ...
 *
 * $Id: rte_dev.h 774418 2019-04-24 07:52:25Z $
 */
...
struct hnd_dev_ops {
	...
	int32  (*flowring_link_update)(hnd_dev_t *dev, uint16 flowid, uint8 op,
	                                uint8 *sa, uint8 *da, uint8 tid, uint8 *mode);

	/* CFP Control exchanges between bus and wl */
	int (*cfp_flow_link)(hnd_dev_t *dev, uint16 ringid, uint8 tid, uint8* da, uint8 op,
