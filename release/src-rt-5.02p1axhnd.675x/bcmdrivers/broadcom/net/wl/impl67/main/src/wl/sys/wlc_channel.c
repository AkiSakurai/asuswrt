 ...
 *
 * $Id: wlc_channel.c 790870 2020-09-07 05:58:56Z $
 */
...
wlc_channel_clm_restricted_chanspec(wlc_cm_info_t *wlc_cmi, chanspec_t chspec)
{
	...
	if (!chspec || !wlc_valid_chanspec_db(wlc_cmi, chspec) ||
		(wlc_country_lookup_direct(wlc_cmi->ccode, wlc_cmi->regrev, &country) !=
		CLM_RESULT_OK) ||
	...
	chanspec_t chanspec)
{
	...
	wlc_bss_mac_event(wlc, wlc->primary_bsscfg, WLC_E_AP_CHAN_CHANGE, NULL, 0,
