...
/* Beamformee STS for > 80MHz */
#define HE_PHY_BFE_STS_ABOVE80 (ACMAJORREV_51_129_131(pi->pubpi->phy_rev) ? 0x0 : 0x3)
/* Total STS for <= 80MHz */
#define HE_PHY_NSTS_BELOW80 (ACMAJORREV_51_131(pi->pubpi->phy_rev) ? 0x1 : \
...
#define HE_PHY_SOUND_DIM_BELOW80 (ACMAJORREV_51_131(pi->pubpi->phy_rev) ? 0x1 : \
				  ACMAJORREV_129(pi->pubpi->phy_rev) ? 0x2 : 0x3)
/* Number of sounding dimensions for > 80MHz */
#define HE_PHY_SOUND_DIM_ABOVE80 (ACMAJORREV_51_129_131(pi->pubpi->phy_rev) ? 0x0 : 0x3)
