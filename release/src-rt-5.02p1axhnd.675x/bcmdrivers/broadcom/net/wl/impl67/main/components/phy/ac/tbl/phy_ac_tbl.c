 ...
 *
 * $Id: phy_ac_tbl.c 789968 2020-08-12 13:37:31Z $
 */
...
wlc_phy_get_txgain_tbl_20708(phy_info_t *pi)
{
	...
	case 1:
		if (CHSPEC_IS2G(pi->radio_chanspec)) {
			tx_pwrctrl_tbl = acphy28nm_txgain_epa_2g_p5_20708a0_rev0;
		} else {
			tx_pwrctrl_tbl = acphy28nm_txgain_epa_5g_p5_20708a0_rev0;
		}
		break;
	default:
		PHY_ERROR(("wl%d: %s: Unsupported radio revision %d\n",
