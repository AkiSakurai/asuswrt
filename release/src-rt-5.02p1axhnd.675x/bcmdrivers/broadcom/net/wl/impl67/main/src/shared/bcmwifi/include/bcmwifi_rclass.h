 ...
 *
 * $Id: bcmwifi_rclass.h 786506 2020-04-29 10:01:44Z $
 */
...
#define BCMWIFI_OP_CLASS_6G_20MHZ	131u /* OP class for 20mhz channel in 6G */
#define BCMWIFI_OP_CLASS_6G_40MHZ	132u /* OP class for 40mhz channel in 6G */
#define BCMWIFI_OP_CLASS_6G_80MHZ	133u /* OP class for 80mhz channel in 6G */
#define BCMWIFI_OP_CLASS_6G_160MHZ	134u /* OP class for 1600mhz channel in 6G */
#define BCMWIFI_OP_CLASS_6G_80_P_80MHZ	135u /* OP class for 80P80mhz channel in 6G */
...
/*
 * Return the op class type for a given country code
 * Input: ccode
 */
bcmwifi_rclass_type_t bcmwifi_rclass_get_rclasstype_from_cntrycode(const char *ccode);
 ...
 * Return BCME_OK on success and BCME_ERROR on error
 */
int bcmwifi_rclass_get_chanspec_from_chan(bcmwifi_rclass_type_t type,
	bcmwifi_rclass_opclass_t rclass, uint8 chn, chanspec_t *cspec);
...
#define FOREACH_RCLASS_INFO(type, rc_info, index) \
	for (index = bcmwifi_rclass_info_iter_start((type), &rc_info); rc_info != NULL; \
		rc_info = bcmwifi_rclass_info_iter_next(rc_info, --index))
