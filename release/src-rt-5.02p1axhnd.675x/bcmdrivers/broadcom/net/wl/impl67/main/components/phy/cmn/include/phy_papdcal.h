 ...
 *
 * $Id: phy_papdcal.h 787578 2020-06-04 01:28:31Z $
 */
...
int phy_papdcal_get_ipaoff(phy_info_t *pi, int32* papdipaoff);
int phy_papdcal_set_ipaoff(phy_info_t *pi, int32 papdipaoff);
int phy_papdcal_get_cts2self(phy_info_t *pi, int32* papdcts2self);
int phy_papdcal_set_cts2self(phy_info_t *pi, int32 papdcts2self);
