 ...
 *
 * $Id: wl_cfgvendor.c 787288 2020-05-25 16:56:02Z $
 */
...
#if (defined(CONFIG_ARCH_MSM) && defined(SUPPORT_WDEV_CFG80211_VENDOR_EVENT_ALLOC)) || \
	LINUX_VERSION_CODE >= KERNEL_VERSION(4, 1, 0)
		skb = cfg80211_vendor_event_alloc(wiphy, ndev_to_wdev(dev), 100,
...
#pragma GCC diagnostic ignored "-Wcast-qual"
	...
	LINUX_VERSION_CODE >= KERNEL_VERSION(4, 1, 0)
		skb = cfg80211_vendor_event_alloc(wiphy, ndev_to_wdev(dev),
		    rtt_header->result_tot_len + 100, GOOGLE_RTT_COMPLETE_EVENT, kflags);
#else
