 ...
 *
 * $Id: blanket.h 791103 2020-09-16 11:11:08Z $
 *
 *  @author
 *  @bug No known bugs.
 */
...
/** @brief Fetch Channel from Chanspec, considering bw_cap
 *
 * @param in_chspec	In : current chanspec
 *
 * @return		channel from current chanspec
 */
unsigned char blanket_chspec_to_channel(chanspec_t in_chspec);
