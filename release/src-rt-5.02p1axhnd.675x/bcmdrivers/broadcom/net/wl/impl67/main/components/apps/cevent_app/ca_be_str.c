...
char *ca_bcm_event_str[202 + 1] = {
	/* fillers from 0 to 202 */
	"E_0",
	"E_1",
	"E_2",
	"E_3",
	...
	[158] =	"E_SPARE_158",		/* available */
	[159] =	"E_SPARE_159",		/* available */
	...
	[182] =	"E_DFS_HIT",		/* Found radar on channel */
	...
	[172] =	"E_AIRIQ_EVENT",	/* AIRIQ driver event */
	...
	[186] =	"E_ASSOC_REASSOC_IND_EXT", /* */
	[187] =	"E_WNM_ERR",		/* BSSTRANS error response */
	[188] =	"E_ASSOC_FAIL",		/* Assoc fail */
	[189] =	"E_REASSOC_FAIL",	/* Reassoc Fail */
	[190] =	"E_AUTH_FAIL",		/* Auth Fail */
	[191] =	"E_BSSTRANS_REQ",	/* BSS Transition Request received */
	[192] =	"E_BSSTRANS_QUERY",	/* BSS Transition Query received */
	[193] =	"E_START_AUTH",		/* Event to initiate External Auth */
	[194] =	"E_OMN_MASTER",		/* OMN Master change event */
	[195] =	"E_MBO_CAPABILITY_STATUS", /* */
	[196] =	"E_WNM_NOTIFICATION_REQ", /* WNM notification request payload from STA */
	[197] =	"E_WNM_BSSTRANS_QUERY",	/* BTM query payload from STA */
	[198] =	"E_GAS_RQST_ANQP_QUERY", /* GAS ANQP query from unassociated STA */
	[199] =	"E_PWR_SAVE_SYNC",	/* Sync pm value with cfg80211 power save */
	[200] =	"E_PROBREQ_MSG_RX_EXT",	/* */
	[201] =	"E_BAND_CHANGE",	/* Band change event */
	[202] =	"E_LAST",		/* */
};
