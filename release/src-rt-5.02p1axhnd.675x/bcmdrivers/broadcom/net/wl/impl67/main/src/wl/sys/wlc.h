 ...
 *
 * $Id: wlc.h 791125 2020-09-17 07:42:53Z $
 */
...
#define WLC_6G_CAP_FD_BCAST_PRB_RSP_MASK			0X00000060 /* bit 5 and 6 */
#define WLC_6G_CAP_BOTH_FD_BCAST_PRB_RSP_ENABLED		0X03
#define WLC_6G_CAP_FD_BCAST_PRB_RSP_BIT_SHIFT			0X05

#define IS_WLC_6G_CAP_BOTH_FD_BCAST_PRB_RSP_BIT_SET(val)		\
	((((val) & WLC_6G_CAP_FD_BCAST_PRB_RSP_MASK) >>			\
		WLC_6G_CAP_FD_BCAST_PRB_RSP_BIT_SHIFT) ==		\
		WLC_6G_CAP_BOTH_FD_BCAST_PRB_RSP_ENABLED)
...
#define UPR_FD_TX_ADD_TIMER(wlc)	wl_add_timer((wlc)->wl, \
	 (wlc->upr_fd_info)->timer, ((wlc)->upr_fd_info)->period, 1)
#define UPR_FD_TX_DEL_TIMER(wlc)	wl_del_timer((wlc)->wl, (wlc->upr_fd_info)->timer)
#define UPR_FD_TX_FREE_TIMER(wlc) wl_free_timer((wlc)->wl, (wlc->upr_fd_info)->timer)

#define WLC_UPR_FD_START_TIMER(upr_fd_info)	(((upr_fd_info)->flags) |= UPR_FD_START_TIMER)

#define WLC_IS_UPR_FD_TIMER_RUNNING(upr_fd_info)	\
	(((upr_fd_info)->flags) & UPR_FD_START_TIMER)
...
/* bit position */
#define WLC_6G_CAP_RNR_IE			0
#define WLC_6G_CAP_PRB_RSP_CANCEL		1
#define WLC_6G_CAP_COLOCATED_RADIO		2
#define WLC_6G_CAP_IN_BAND_DISCOVERY		3
#define WLC_6G_CAP_OOB_DISCOVERY		4
#define WLC_6G_CAP_20TU_BCAST_PRB_RSP		5
#define WLC_6G_CAP_20TU_FILS_DISCOVERY		6
#define WLC_6G_CAP_NO_WILDCARD_PRBREQ		7 /* do not tx/rx wildcard broadcast prb request */
