 ...
 *
 * $Id: phy_ac_rxspur.c 787921 2020-06-16 10:52:43Z $
 */
...
static const uint32 acphy_spurcan_spur_freqKHz_rev130[] = {2450000,
	5200000, 5300000, 5400000, 5500000, 5600000, 5700000, 5750000, 5800000};
...
BCMATTACHFN(phy_ac_rxspur_std_params)(phy_ac_rxspur_info_t *rxspuri)
{
	...
	if (ACMAJORREV_130(pi->pubpi->phy_rev)) {
		rxspuri->spurcan_CoreMask = ISSIM_ENAB(pi->sh->sih) ?
			0xf : stf_shdata->hw_phytxchain;
	}
