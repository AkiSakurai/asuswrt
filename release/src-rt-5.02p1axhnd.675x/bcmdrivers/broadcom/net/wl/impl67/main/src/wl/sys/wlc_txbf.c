 ...
 *
 * $Id: wlc_txbf.c 790450 2020-08-25 14:26:46Z $
 */
...
#define IMPBF_REV_GE64_USR_IDX	7
	...
	uint8 bfe_override_disable; /* disallow bfe disable for smth/tdcs */
};
...
static const bcm_iovar_t txbf_iovars[] = {
	...
	{"txbf_bfe_override_disable", IOV_TXBF_BFE_OVERRIDE_DIS,
	(0), 0, IOVT_UINT8, 0
	},
	{NULL, 0, 0, 0, 0, 0}
};
	...
	void *p, uint plen, void *a, uint alen, uint vsize, wlc_if_t *wlcif)
{
	...
	case IOV_SVAL(IOV_TXBF_CFG):
		...
		break;
#endif // endif
	case IOV_GVAL(IOV_TXBF_BFE_OVERRIDE_DIS):
		*ret_int_ptr = txbf->bfe_override_disable;
		break;
	case IOV_SVAL(IOV_TXBF_BFE_OVERRIDE_DIS):
		txbf->bfe_override_disable = (uint8)int_val;
		break;
