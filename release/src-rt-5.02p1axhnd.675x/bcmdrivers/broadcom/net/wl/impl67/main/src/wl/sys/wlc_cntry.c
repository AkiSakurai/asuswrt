 ...
 *
 * $Id: wlc_cntry.c 790412 2020-08-25 06:06:59Z $
 */
	...
	wlc_cntry_info_t *cm, uint8 *cp, int buflen)
{
	...
	max_chan++;
	/* TODO:6GHZ:Subband support for BCMWIFI_RCLASS_TYPE_GBL is handled.
	 * Need to update to support other rclass_types
	 */
