...
extern uint wlc_iem_calc_ie_len_ex(wlc_iem_info_t *iem, wlc_bsscfg_t *cfg, uint16 ft,
...
extern int wlc_iem_build_ie_ex(wlc_iem_info_t *iem, wlc_bsscfg_t *cfg, uint16 ft,
