 ...
 *
 * $Id: wlc_wnm.h 580138 2015-08-18 07:50:34Z $
 */
...
extern void wlc_wnm_recv_process_uwnm(wlc_wnm_info_t *wnm, wlc_bsscfg_t *bsscfg,
	...
	uint8 *body, int body_len);
#else
#define wlc_wnm_recv_process_uwnm(a, b, c, d, e, f, g) do {} while (0)
...
#else
#define wlc_wnm_timbc_resp_ie_process(a, b, c, d)	(BCME_OK)
#define wlc_wnm_timbc_assoc(a, b, c)	(NULL)
#define wlc_wnm_check_dms_req(a, b)	do {} while (0)
#define wlc_wnm_bsstrans_roamscan_complete(a, b, c)	(FALSE)
#define wlc_wnm_bss_pref_score_rssi(a, b, c, d)	(BCME_ERROR)
#define wlc_wnm_process_join_trgts_bsstrans(a, b, c)	do {} while (0)
#define wlc_wnm_bsstrans_zero_assoc_bss_score(a)	(TRUE)
#define wlc_wnm_bsstrans_is_join_pending(a)	(FALSE)
#define wlc_wnm_bsstrans_reset_pending_join(a)	do {} while (0)
#define wlc_wnm_bsstrans_get_scoredelta(a)	(0)
#define wlc_wnm_bsstrans_is_product_policy(a)	(TRUE)
#endif /* STA && !WLWNM_AP_ONLY */
#endif	/* _wlc_wnm_h_ */
