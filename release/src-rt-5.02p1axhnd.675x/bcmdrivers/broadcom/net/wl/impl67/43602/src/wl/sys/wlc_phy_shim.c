 ...
 *
 * $Id: wlc_phy_shim.c 489156 2014-07-03 21:49:47Z $
 */
...
void
wlapi_update_wl_ant_info_to_bt(wlc_phy_shim_info_t *physhim, uint8 txchain,
	uint8 rxchain)
{
	wlc_bmac_update_wl_ant_info_to_bt(physhim->wlc_hw, txchain, rxchain);
}
