 ...
 *
 * $Id: wlc_bsscfg.h 784961 2020-03-10 06:53:38Z $
 */
...
#endif // endif
#ifdef WL_SAE
#define BSSCFG_EXT_AUTH(cfg) (((cfg)->auth == DOT11_SAE) && (BSSCFG_STA(cfg)))
#else
...
#ifdef WL_SAE
	uint16		PAD0;	/* WPA: authenticated key management */
#else
...
#define WLC_BSSCFG_FL2_MFP_CAPABLE      0x200    /**< The BSS is for MFP capable flag */
#define WLC_BSSCFG_FL2_MFP_REQUIRED     0x400    /**< The BSS is for MFP required flag */
