 ...
 *
 * $Id: wlc_key.h 656756 2016-08-30 00:27:39Z $
 */
...
#endif /* defined(BCMWAPI_WPI) || defined(BCMWAPI_WPI_COMPAT) */
...
#define WSEC_KEY_VALID(scb_key) (((scb_key) && (scb_key)->len) ? TRUE : FALSE)
...
#endif /* MFP */
#if (defined(BCMCCX) && defined(CCX_SDK)) || (defined(MFP) && !defined(MFP_DISABLED))
...
typedef struct wsec_key {
...
#endif // endif
#ifdef BCMCCX
	uint32		txseq;		/* tx sequence number for CKIP */
	uint32		rxseq_base;	/* base rx sequence number for CKIP */
	uint32		rxseq_bitmap;	/* consumed rx sequence number flag for CKIP */
	uint32		mrxseq_base;	/* multicast base rx sequence number for CKIP */
	uint32		mrxseq_bitmap;	/* multicast consumed rx sequence number flag for CKIP */
#endif /* BCMCCX */
...
#endif /* defined(BCMWAPI_WAI) || defined(BCMWAPI_WAI_COMPAT) */
#endif /* defined(BCMWAPI_WPI) || defined(BCMWAPI_WPI_COMPAT) */
#ifdef GTK_RESET
	bool		gtk_plumbed;
#endif /* GTK_RESET */
	...
	uint8		last_rxiv;	/* rxiv of last received frame */
...
#ifdef BCMCCX
#define	WSEC_CKIP_MMH		(1 << 4)	/* CMIC */
#define	WSEC_CKIP_KP		(1 << 5)	/* CKIP */
#endif /* BCMCCX */
