...
extern void scbtag_flush_txc_info(void);
#endif // endif
...
extern void wlc_txc_iv_upd(wlc_txc_info_t *txc, wlc_bsscfg_t *cfg,
	struct scb *scb, wsec_key_t *key, bool uc_seq);
/* check if the cache has the entry */
extern bool wlc_txc_hit(wlc_txc_info_t *txc, wlc_bsscfg_t *cfg, struct scb *scb,
...
extern void wlc_txc_add(wlc_txc_info_t *txc, wlc_bsscfg_t *cfg, struct scb *scb,
