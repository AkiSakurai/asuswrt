 ...
 *
 * $Id: ccx.c 241182 2011-02-17 21:50:03Z $
 */
...
void BCMROMFN(CKIP_key_permute)(uint8  *PK, const uint8 *CK, uint8  toDsFromDs, const uint8 *piv);
int BCMROMFN(wsec_ckip_mic_compute)(const uint8 *CK, const uint8 *pDA, const uint8 *pSA,
                                    const uint8 *pSEQ, const uint8 *payload, int payloadlen,
                                    const uint8 *p2, int len2, uint8 pMIC[]);
int BCMROMFN(wsec_ckip_mic_check)(const uint8 *CK, const uint8 *pDA, const uint8 *pSA,
...
void
BCMROMFN(CKIP_key_permute)(uint8  *PK,		/* output permuted key */
 ...
 */
int
BCMROMFN(wsec_ckip_mic_compute)(const uint8 *CK, const uint8 *pDA, const uint8 *pSA,
                                const uint8 *pSEQ, const uint8 *payload, int payloadlen,
                                const uint8 *p2, int len2, uint8 pMIC[])
{
	mic_context ctx;
 ...
 */
int
BCMROMFN(wsec_ckip_mic_check)(const uint8 *CK, const uint8 *pDA, const uint8 *pSA,
                              const uint8 *payload, int payloadlen, uint8 mic[])
{
	mic_context ctx;
