 ...
 *******************************************************************************
 * File Name  : fcctl.h
 * Description: Command line parsing for the Broadcom Flow Cache Control Utility
 *******************************************************************************
 */
...
/* Return codes. */
#define FCCTL_GENERAL_ERROR                 100
#define FCCTL_NOT_FOUND                     101
#define FCCTL_ALLOC_ERROR                   102
#define FCCTL_INVALID_COMMAND               103

#define FCCTL_INVALID_OPTION                104
#define FCCTL_INVALID_PARAMETER             105
#define FCCTL_INVALID_NUMBER_OF_OPTIONS     106
#define FCCTL_INVALID_NUMBER_OF_PARAMETERS  107
